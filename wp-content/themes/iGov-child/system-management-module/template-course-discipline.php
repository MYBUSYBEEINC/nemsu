<?php //Template Name: System - Course Details Management - Course Discipline ?>
    ...
    <div class="class-container">
        ...
        <?php if(isset($_GET['delete']) || isset($_GET['deleted'])){
            if($_GET['delete']){
                ...
                <script>
                    window.location.href = "<?php echo site_url().'/system/course-details-management/course-discipline/?deleted='.$_GET['delete']; ?>";
                </script>
            <?php } ?>

            <div id="alert-container">
                <div class="alert alert-danger" role="alert">
                    <i class="fa fa-trash" aria-hidden="true"></i> Course Discipline has been successfully deleted.
                </div>
            </div>
        ...
        <?php if(isset($_GET['submitted']) || isset($_GET['changeTitle'])){
            ...
            if($_GET['changeTitle']){
                ...
                $data = array(
                    ...
                    'post_title'   => get_field('course_discipline', $getCurrentlySubmittedID),
                );

                wp_update_post( $data );
                ?>
                <script>
                    window.location.href = "<?php echo site_url().'/system/course-details-management/course-discipline/?submitted='.$getCurrentlySubmittedID; ?>";
                </script>
            <?php } else {
            ...
            <div id="alert-container">
                <div class="alert alert-success" role="alert">
                    <i class="fa fa-check-circle" aria-hidden="true"></i> Success! Course Discipline has been successfully created.
                </div>
            </div>
        <?php } ?>
        ...
        <div class="bg-white padding-15 border-radius-5">
            <div class="page-title-container">
                <h4 class="card-title">Course Details Management - Course Discipline</h4>
            </div>
                ...
                <tbody>
                    ...
                    if ( have_posts() ) : 
                        while ( have_posts() ) : the_post(); 
                            ...
                            <tr>
                                <td><?php the_field('course_discipline_code'); ?></td>
                                <td><?php the_field('course_discipline'); ?></td>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title"><?php the_field('course_discipline'); ?></h5>
                                                </div>
                                                <div class="modal-body">
                                                    <table>
                                                        <tr>
                                                            <td><strong>Course Discipline Code</strong></td>
                                                            <td><?php the_field('course_discipline_code'); ?></td>
                                                        </tr>
                                                        <tr>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="button" class="btn btn-primary" onclick="window.location.href='<?php echo site_url(); ?>/system/course-details-management/course-discipline/?delete=<?php echo get_the_id(); ?>'">Confirm</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<div class="modal fade newModal" id="addNewModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Create New Course Discipline</h5>
            </div>
            <div class="modal-body">
                <div class="acf-container">
                    ...
                    acf_form(array(
                        'post_id'       => 'new_post',
                        'field_groups'  => array(
                            'group_637c88ca21b1b',  // Course Discipline
