<?php //Template Name: System - Faculty Details Management - Faculty Ranks ?>
    ...
    <div class="class-container">
        ...
        <?php if(isset($_GET['delete']) || isset($_GET['deleted'])){
            if($_GET['delete']){
                ...
                <script>
                    window.location.href = "<?php echo site_url().'/system/faculty-details-management/faculty-rank/?deleted='.$_GET['delete']; ?>";
                </script>
            <?php } ?>

            <div id="alert-container">
                <div class="alert alert-danger" role="alert">
                    <i class="fa fa-trash" aria-hidden="true"></i> Faculty Rank has been successfully deleted.
                </div>
            </div>
        ...
        <?php if(isset($_GET['submitted']) || isset($_GET['changeTitle'])){
            ...
            if($_GET['changeTitle']){
                ...
                $data = array(
                    ...
                    'post_title'   => get_field('faculty_rank', $getCurrentlySubmittedID),
                );

                wp_update_post( $data );
                ?>
                <script>
                    window.location.href = "<?php echo site_url().'/system/faculty-details-management/faculty-rank/?submitted='.$getCurrentlySubmittedID; ?>";
                </script>
            <?php } else {
            ...
            <div id="alert-container">
                <div class="alert alert-success" role="alert">
                    <i class="fa fa-check-circle" aria-hidden="true"></i> Success! Faculty Rank has been successfully created.
                </div>
            </div>
        <?php } ?>
        ...
        <div class="course-cards">
                ...
                <div class="col-mid-50">
                    <div class="padding-lr-5">
                        <div class="card-nav card-red padding-15">
                            ...
                            <h4 class="card-title mt-2 mb-0">Faculty List</h4>
            ...
            <a href="<?php echo site_url(); ?>/system/faculty-details-management/faculty-rank/">
                <div class="col-mid-50">
                    <div class="padding-lr-5">
                        <div class="card-nav card-blue1 padding-15">
                            ...
                            <h4 class="card-title mt-2 mb-0">Faculty Rank</h4>
                            <p class="card-text">Lorem ipsum dolor sit amet</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="bg-white padding-15 border-radius-5">
            <div class="page-title-container">
                <h4 class="card-title">Faculty Details Management - Faculty Rank</h4>
            </div>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title"><?php the_field('faculty_rank'); ?></h5>
                                                </div>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="button" class="btn btn-primary" onclick="window.location.href='<?php echo site_url(); ?>/system/faculty-details-management/faculty-rank/?delete=<?php echo get_the_id(); ?>'">Confirm</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<div class="modal fade newModal" id="addNewModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Create New Faculty Rank</h5>
            </div>
            <div class="modal-body">
