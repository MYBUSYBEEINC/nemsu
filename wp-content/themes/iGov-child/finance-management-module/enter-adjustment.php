    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card border-0 p-0 mt-3 mb-5">
                <h5 class="card-header bg-white border-0 text-capitalize mt-3 ml-2"><?=$title?></h5>
                <div class="card-body p-0">
                    ...
                    <div class="container">
                        <div class="row mt-3 mb-3">
                            ...
                            <div class="col-lg-4">
                                    <input type="submit" name="btn-find-student" class="mt-4 btn btn-sm btn-secondary rounded" style="background:red;margin-top:-12px" value="Find">
                                </form>   
                            </div>
                        </div>
                        <div class="row mt-3 mb-3">
