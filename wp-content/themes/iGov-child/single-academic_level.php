        ...
        <?php if(isset($_GET['submitted'])){ ?>
            ...
            <div id="alert-container">
                <div class="alert alert-success" role="alert">
                    <i class="fa fa-check-circle" aria-hidden="true"></i> Success! <strong><?php echo get_field('academic_level', $getCurrentlySubmittedID); ?></strong> has been successfully edited.
                </div>
            </div>
        <?php } ?>
            ...
            <?php if(isset($_GET['edit'])) { ?>
                ...
                <div class="acf-container">
                    ...
                    acf_form(array(
                        'post_id' => $$_GET['edit'],
                        'field_groups' => array(
                            'group_6373513d520c5'  // Department
                        ) ,
                        $$_GET['edit'] => array(
