    ...
    <div class="class-container">
        ...
        <?php if(isset($_GET['submitted'])){ ?>
            ...
            <div id="alert-container">
                <div class="alert alert-success" role="alert">
                    <i class="fa fa-check-circle" aria-hidden="true"></i> Success! <strong><?php echo get_field('course_schedule_pros', $getCurrentlySubmittedID); ?></strong> has been successfully edited.
                </div>
            </div>
        <?php } ?>
        ...
        <div class="bg-white padding-15 border-radius-5">
            <div class="page-title-container">
                <h4 class="card-title">Schedule Proposal</h4>
            </div>
