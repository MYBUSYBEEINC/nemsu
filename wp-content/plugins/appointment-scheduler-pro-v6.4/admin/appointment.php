...
<script type="text/javascript">
	...
	// jQuery(document).ready(function() {
	// 	jQuery("#exportsags").hide();
	// }
	function get_report(){
		var single_date = jQuery("#ap_datepicker_single").val();		
		var double_1_date = jQuery("#ap_datepicker_double_1").val();		
		var double_2_date = jQuery("#ap_datepicker_double_2").val();
		var month = jQuery("#ap_datepicker_month").val();
		var year = jQuery("#ap_datepicker_year").val();
		var datas;		
		jQuery("#exportsags").attr("href", "");		
		if(single_date != ''){
			datas = jQuery('#download_report_form').serialize();			
		}
		else if(double_1_date != '' && double_2_date != ''){
			datas = "start_date=" + double_1_date +"&end_date=" + double_2_date; 		
		}
		else if(month != ''){
			alert(month);
			datas = "month=" + month;
		...
		jQuery.ajax({
				type : 'post',
				url : ajaxurl+'?action=download_ajax_reports',  
		        data :  datas,
		        dataType: "html",
		        success : function(data){
		        	jQuery("#exportsags").show();	    		
					console.log(data);		
					// alert(data);		
					csvData = 'data:application/csv;charset=utf-8,' + encodeURIComponent(data);
			        jQuery("#exportsags").attr({
			            "href": csvData,
			            "download": "sag_data"+single_date+".csv"
			        });
				}
			});
		}		
				...
				if($notification_admin_wp_email !==""){
					...
					if($notification_staff_pending=="yes"){
						...
						if($notification_subject_staff_pending !=="" &&  $notification_body_staff_pending !==""){
							...
							$from_admin_email = $notification_admin_wp_email;
							$header = "From: $admin_name <$from_admin_email>" . "\r\n";
							$wp_mail_check_staff = wp_mail( $to_staff_email_pending, $subject_staff_pending, $body_staff_pending, $header );
						}
					}
								//ADMIN PENDING
					...
					if($notification_admin_pending=="yes"){
						...
						if($notification_subject_admin_pending !=="" &&  $notification_body_admin_pending !==""){
							...
							$from_admin_email = $notification_admin_wp_email;
							$header = "From: $admin_name <$from_admin_email>" . "\r\n";
							$wp_mail_check_admin = wp_mail( $to_admin_email_pending, $subject_admin_pending, $body_admin_pending, $header );
						}
					}
				}
			}
				...
				if($notification_admin_wp_email !==""){
					...
					if($notification_staff_approved=="yes"){
						...
						if($notification_subject_staff_approved !=="" &&  $notification_body_staff_approved !==""){
							...
							$from_admin_email = $notification_admin_wp_email;
							$header = "From: $admin_name <$from_admin_email>" . "\r\n";
							$wp_mail_check_staff = wp_mail( $to_staff_email_approved, $subject_staff_approved, $body_staff_approved, $header );
						}
					}
								//ADMIN APPROVED
					...
					if($notification_admin_approved=="yes"){
						...
						if($notification_subject_admin_approved !=="" &&  $notification_body_admin_approved !==""){
							...
							$from_admin_email = $notification_admin_wp_email;
							$header = "From: $admin_name <$from_admin_email>" . "\r\n";
							$wp_mail_check_admin = wp_mail( $to_admin_email_approved, $subject_admin_approved, $body_admin_approved, $header );
						}
					}
				}
			}
				...
				if($notification_admin_wp_email !==""){
					if($notification_client_cancel=="yes"){
						...
						if($notification_subject_client_cancel !=="" &&  $notification_body_client_cancel !==""){
							...
							$from_admin_email = $notification_admin_wp_email;
							$header = "From: $admin_name <$from_admin_email>" . "\r\n";
							$wp_mail_check_client = wp_mail( $to_client_email_cancel, $subject_client_cancel, $body_client_cancel, $header );
						}
					}
								//STAFF CANCEL
					...
					if($notification_staff_cancel=="yes"){
						...
						if($notification_subject_staff_cancel !=="" &&  $notification_body_staff_cancel !==""){
							...
							$from_admin_email = $notification_admin_wp_email;
							$header = "From: $admin_name <$from_admin_email>" . "\r\n";
							$wp_mail_check_staff = wp_mail( $to_staff_email_cancel, $subject_staff_cancel, $body_staff_cancel, $header );
						}
					}
								//ADMIN CANCEL
					...
					if($notification_admin_cancel=="yes"){
						...
						if($notification_subject_admin_cancel !=="" &&  $notification_body_admin_cancel !==""){
							...
							$from_admin_email = $notification_admin_wp_email;
							$header = "From: $admin_name <$from_admin_email>" . "\r\n";
							$wp_mail_check_admin = wp_mail( $to_admin_email_cancel, $subject_admin_cancel, $body_admin_cancel, $header );
						}
					}
				}
			}
				...
				if($notification_admin_php_email !==""){
					...
					if($notification_staff_pending=="yes"){
						...
						if($notification_subject_staff_pending !=="" &&  $notification_body_staff_pending !==""){
							...
							$from_admin_email = $notification_admin_php_email;
							$header = "From: $admin_name <$from_admin_email>" . "\r\n";
							$mail_check_staff_pending = mail ($to_staff_email_pending,$subject_staff_pending,$body_staff_pending,$header);
						}
					}
								//ADMIN PENDING							
					$notification_admin_pending= $email_settings['send_notification_admin_pending'];
				...
				if($notification_admin_php_email !==""){
					...
					if($notification_staff_approved=="yes"){
						...
						if($notification_subject_staff_approved !=="" &&  $notification_body_staff_approved !==""){
							...
							$from_admin_email = $notification_admin_php_email;
							$header = "From: $admin_name <$from_admin_email>" . "\r\n";
							$mail_check_staff_approved = mail ($to_staff_email_approved,$subject_staff_approved,$body_staff_approved,$header);
						}
					}	
								//ADMIN APPROVED
					$notification_admin_approved= $email_settings['send_notification_admin_approved'];
				...
				if($notification_admin_php_email !==""){
					...
					if($notification_staff_cancel=="yes"){
						...
						if($notification_subject_staff_cancel !=="" &&  $notification_body_staff_cancel !==""){
							...
							$from_admin_email = $notification_admin_php_email;
							$header = "From: $admin_name <$from_admin_email>" . "\r\n";
							$mail_check_staff_cancel = mail ($to_staff_email_cancel,$subject_staff_cancel,$body_staff_cancel,$header);
						}
					}	
								//ADMIN CANCEL
...
?>				
			<div class="panel panel-default">
				<div class="panel-heading"><i class="fas fa-thumbtack"></i><span class="panel_heading"><?php _e("Appointments",WL_A_P_SYSTEM );?></span> 
					<div class="theme-export d-client">
						<a <?php staff_appoint_auth(); ?> class="btn theme-customer"  href="#reports" data-toggle="modal" data-target="#reports"><?php _e("Download Reports",WL_A_P_SYSTEM );?> </a>
							  ...
							  <div class="modal-dialog" role="document">
							    <div class="modal-content">
							      ...
							      <div class="modal-body">							       
									<!-- Nav tabs -->
									  <ul class="nav nav-tabs" role="tablist">
									    <li role="presentation" class="active"><a href="#accord_date" aria-controls="accord_date" role="tab" data-toggle="tab">According To Date</a></li>
									    <li role="presentation"><a href="#month" aria-controls="month" role="tab" data-toggle="tab">Monthly</a></li>
									    <li role="presentation"><a href="#year" aria-controls="year" role="tab" data-toggle="tab">Yearly</a></li>
									    <li role="presentation"><a href="#between_dates" aria-controls="between_dates" role="tab" data-toggle="tab">Between Dates</a></li>
									  </ul>

									  <!-- Tab panes -->
									  <div class="tab-content">
									    <div role="tabpanel" class="tab-pane fade in active" id="accord_date">
									    	 <div class="form-group">
												<form method="post" id="download_report_form">
													<div class="row cus-reg" id="appoint_staff_single">
														<label><?php _e("Download Report According To Date:",WL_A_P_SYSTEM );?>  </label>
														<input type="text" class="col-md-6 a_dates" id="ap_datepicker_single" name="ap_datepicker_single">
													</div>
													<button type="button" class="btn btn-secondary generate_link" onclick="get_report()" >Generate Download Link</button>													
												</form>												
											</div>
									    </div>
									    <div role="tabpanel" class="tab-pane fade" id="month">
									    	<div class="form-group">
												<form method="post" id="download_report_form">
													<div class="row cus-reg" id="appoint_staff_month">
														<label><?php _e("Download Report According To Month:",WL_A_P_SYSTEM );?>  </label>
														<!-- <input type="text" class="col-md-12 ap_datepicker_month" id="ap_datepicker_month" name="ap_datepicker_month"> -->
														<select id="ap_datepicker_month" name="ap_datepicker_month" class="ap_datepicker_month form-control col-md-6">
															<option value="">Select Month</option>
															<?php
																$months = array(1 => 'Jan.', 2 => 'Feb.', 3 => 'Mar.', 4 => 'Apr.', 5 => 'May', 6 => 'Jun.', 7 => 'Jul.', 8 => 'Aug.', 9 => 'Sep.', 10 => 'Oct.', 11 => 'Nov.', 12 => 'Dec.');
																foreach ($months as $month_no => $month_name) {
																	?>
																	<option value="<?php echo $month_no; ?>"><?php echo $month_name; ?></option>
																	<?php													
																}
															?>
														</select>
									    ...
									    <div role="tabpanel" class="tab-pane fade" id="year">
									    	<div class="form-group">
												<form method="post" id="download_report_form">
													<div class="row cus-reg" id="appoint_staff_year">
														<label><?php _e("Download Report According To Year:",WL_A_P_SYSTEM );?>  </label>
														<!-- <input type="text" class="col-md-12 a_dates" id="ap_datepicker_year" name="ap_datepicker_year"> -->
														<?php 
															// $years = array_combine(range(date("Y"), 1910), range(date("Y"), 1910));
															$years = range(date("Y"), 2016);															
														?>
														<select id="ap_datepicker_year" name="ap_datepicker_year" class="form-control col-md-6 ap_datepicker_year">
									    ...
									    <div role="tabpanel" class="tab-pane fade" id="between_dates">
									    	 <div class="form-group">
												<form method="post" id="download_report_form">
													<div class="row cus-reg" id="appoint_staff_two_dates">
														<label><?php _e("Download Report According To Date:",WL_A_P_SYSTEM );?>  </label>
														<input type="text" class="col-md-6 a_dates" id="ap_datepicker_double_1" name="ap_datepicker_double_1" placeholder="Start Date">
														<input type="text" class="col-md-6 a_dates" id="ap_datepicker_double_2" name="ap_datepicker_double_2" placeholder="End Date">
													</div>
													<button type="button" class="btn btn-secondary generate_link" onclick="get_report()" >Generate Download Link</button>													
												</form>
							      ...
							      <div class="modal-footer">
							      	<a style="display: none;" class="btn display_download" id="exportsags" >Download</a>
					...
					<div class="theme-new-customer d-client">
									...
									<div class="modal-body">
										<div class="form-group">
											<form action="" method="post" id="appoint_form">
												...
												<div class="row">
													<div class="col-md-6">
														<div class="cus-reg" id="appoint_customer">
						...
						<table  id="appointment_example" class="display" cellspacing="0" width="100%">
							<thead>								
								<tr>
									...
									<th class="sh_ow"><?php _e("Id",WL_A_P_SYSTEM );?> </th>
									<th><?php _e("Date & Time",WL_A_P_SYSTEM );?> </th>
									...
									<th><?php _e("Location",WL_A_P_SYSTEM );?> </th>
...
<script>
	...
	/*jQuery(function() {
	    jQuery('.ap_datepicker_month').datepicker( {
	        // changeMonth: true,
	        // changeYear: false,
	        // dateFormat: 'MM',
			changeMonth: true,
			...
			onClose: function (dateText, inst) {
			    ...
			    var month = jQuery("#ap_datepicker_month :selected").val();

			    //Get the selected year value
			    var year = jQuery("#ap_datepicker_month :selected").val();
 ...
 <style type="text/css">
    /*#ap_datepicker_month.ui-datepicker-calendar, #ap_datepicker_month .ui-datepicker-year{
        display: none;
    }*/
 </style>