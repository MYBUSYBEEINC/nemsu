<?php
//FETCH HOLIDAY RECORD ON UPDATE
global $wpdb;
...
<form action="" method="post" id="form_holiday_update">
	...
	<div class="row">
		...
		<div class="ad-ser hide_repeat_day all_hide" style="display:none">
			<div class="col-md-6">
				...
				<input name="re_days_update" id="re_days_update" type="text" value="<?php if($appointment_apt_holidays->repeat_days !="") { echo $appointment_apt_holidays->repeat_days; } else { echo "0"; } ?>" maxlength="2" class="form-control"  />
			</div>
		</div>
		...
		<div class="ad-ser hide_repeat_week all_hide" style="display:none">	  
			<div class="col-md-6">
				...
				<input name="re_weeks_update" id="re_weeks_update" value="<?php if( $appointment_apt_holidays->repeat_weeks != "") { echo $appointment_apt_holidays->repeat_weeks;} else echo '0';  ?>" type="number"  maxlength="2" class="form-control" />
			</div>
		</div>
		...
		<div class="ad-ser hide_bi_repeat_week all_hide" style="display:none">
			<div class="col-md-6">
				...
				<input name="re_biweeks_update" id="re_biweeks_update" value="<?php if($appointment_apt_holidays->repeat_bi_weeks != "") { echo $appointment_apt_holidays->repeat_bi_weeks; } else { echo "0" ;}  ?>" type="number"  maxlength="2" class="form-control" />
			</div>
		</div> 
	...
	<div class="row ad-ser all_hide p_date_show all_hide" style="display:none">
		<div class="col-md-6 col-sm-6">
			...
			<input name="start_date_update" id="start_date_update" type="text" value="<?php echo $appointment_apt_holidays->start_date;  ?>" maxlength="2" class="form-control holiday_dates" />
		</div>
		
		
		<div class="col-md-6 col-sm-6">
			<label ><?php _e('End Date',WL_A_P_SYSTEM); ?></label>
			<input name="end_date_update" id="end_date_update" value="<?php echo $appointment_apt_holidays->end_date;  ?>" type="text" class="form-control holiday_dates" />
		</div>
	</div>	
	<div class="col-md-12 col-sm-12">
