...
<div class="wrap elw-page-welcome about-wrap seting-page">
    <div class="col-md-12 settings">
        <div class=" col-md-4">
            <div class="col-md-6">
                <img src="<?php echo RPGP_PLUGIN_URL . '/images/logo.png'; ?>" alt="logo"/>
            </div>
        </div>
        <div class=" col-md-8">
    ...
    <div class="tab-content">
        <div id="themesd" class="tab-pane fade in active">
            <div class="space  theme active">
                ...
                <div class="  p_plugin blog_gallery clearfix">
                    <div class="col-xs-12 col-sm-4 col-md-5 p_plugin_pic">
                        <div class="img-thumbnail">
                            <img src="<?php echo RPGP_PLUGIN_URL . 'images/BeautySpa.jpg'; ?>" class="img-responsive"
                                 alt="img"/>
                    ...
                    <div class="col-xs-12 col-sm-5 col-md-5 p_plugin_desc">
                        <div class=" p-box">
                            ...
                            <p><strong>Tags: </strong>Customize Front Page, Multilingual, Complete Documentation, Theme
                                Option Panel, Unlimited Color Skins, Multiple Background Patterns, Multiple Theme
                                Templates, 5 Portfolio Layout, 3 Page Layout and many more.</p>
                            <div>
                                <p><strong>Description: </strong> BeautySpa is versatile health care business WordPress
                                    theme suitable for spa, spa salon, sauna, massage , medical business, massage
                                    center, beauty center, eCommerce and beauty salon websites.</p>
                            </div>
                        </div>
                    </div>
                    <div class="  p_plugin_pic">
                        ...
                        <div class="btn-group-vertical">
                            <a class="btn btn-primary btn-lg"
                               href="https://weblizar.com/themes/beautyspa-premium/">Demo</a>
                            <a class="btn btn-success btn-lg" href="https://weblizar.com/themes/beautyspa-premium/">Buy
                                Now</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="  p_plugin blog_gallery clearfix clearfix">
                    <div class="col-xs-12 col-sm-4 col-md-5 p_plugin_pic">
                        <div class="img-thumbnail">
                            <img src="<?php echo RPGP_PLUGIN_URL . 'images/personal.jpg'; ?>" class="img-responsive"
                                 alt="img"/>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-5 col-md-5 p_plugin_desc">
                        <div class=" p-box">
                            ...
                            <div>
                                <p><strong>Description: </strong> Personal Premium is a powerful and flexible,
                                    customizable and extensively developed, wonderfully lightweight and mobile friendly,
                                    easy to use and intuitively structured. Personal Premium is a highly customizable
                                    and SEO friendly responsive WordPress theme you have access to unlimited color
                                    variations, multiple different layout options, shortcode modules, and much more.
                            </div>
                        </div>
                    </div>
                    <div class=" p_plugin_pic">
                        ...
                        <div class="btn-group-vertical">
                            <a class="btn btn-primary btn-lg"
                               href="https://weblizar.com/themes/personal-premium/">Demo</a>
                            <a class="btn btn-success btn-lg" href="https://weblizar.com/themes/personal-premium">Buy
                                Now</a>
                        </div>
                    </div>
                </div>
                <div class="  p_plugin blog_gallery clearfix clearfix">
                    <div class="col-xs-12 col-sm-4 col-md-5 p_plugin_pic">
                        <div class="img-thumbnail">
                            <img src="<?php echo RPGP_PLUGIN_URL . 'images/explora.jpg'; ?>" class="img-responsive"
                                 alt="img"/>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-5 col-md-5 p_plugin_desc">
                        <div class=" p-box">
                            ...
                            <div>
                                <p><strong>Description: </strong> Explora Premium is a multi-purpose responsive theme
                                    coded & designed with a lot of care and love. You can use it for your business,
                                    portfolio, blogging or any type of site.</div>
                        </div>
                    </div>
                    <div class="  p_plugin_pic">
                        <div class="price">
                ...
                <div class="  p_plugin blog_gallery clearfix clearfix">
                    <div class="col-xs-12 col-sm-4 col-md-5 p_plugin_pic">
                        <div class="img-thumbnail">
                            <img src="<?php echo RPGP_PLUGIN_URL . 'images/Guardian.jpg'; ?>" class="img-responsive"
                                 alt="img"/>
                    ...
                    <div class="col-xs-12 col-sm-5 col-md-5 p_plugin_desc">
                        <div class=" p-box">
                            ...
                            <p><strong>Tags: </strong>Multiple Background Patterns, Rich color changer, Boxed/wide
                                layout styles, Additional Page, WPML & Woo Commerce.</p>
                            <div>
                                <p><strong>Description: </strong> Guardian Premium Theme is a super professional one
                                    page WordPress theme for modern businesses. Ideal for creative agencies, startups,
                                    small businesses, and freelancers and best of all it is so easy to use that you can
                                    have your website up in minutes.</p>
                            </div>
                        </div>
                    </div>
                    <div class="  p_plugin_pic">
                        ...
                        <div class="btn-group-vertical">
                            <a class="btn btn-primary btn-lg"
                               href="https://weblizar.com/themes/guardian-premium-theme/">Detail</a>
                            <a class="btn btn-success btn-lg"
                               href="https://weblizar.com/themes/guardian-premium-theme/">Buy Now</a>
                        </div>
                    </div>
                </div>
                <div class="   p_plugin blog_gallery clearfix clearfix">
                    <div class="col-xs-12 col-sm-4 col-md-5 p_plugin_pic">
                        <div class="img-thumbnail">
                            <img src="<?php echo RPGP_PLUGIN_URL . 'images/Enigma.jpg'; ?>" class="img-responsive"
                                 alt="img"/>
                    ...
                    <div class="col-xs-12 col-sm-5 col-md-5 p_plugin_desc">
                        <div class=" p-box">
                            ...
                            <div>
                                <p><strong>Description: </strong> Enigma is a Full Responsive Multi-Purpose Theme
                                    suitable for Business , corporate office and others .Cool Blog Layout and full width
                                    page also present.</p>
                            </div>
                        </div>
                    </div>
                    <div class="  p_plugin_pic">
                        ...
                        <div class="btn-group-vertical">
                            <a class="btn btn-primary btn-lg"
                               href="https://weblizar.com/themes/enigma-premium/">Detail</a>
                            <a class="btn btn-success btn-lg" href="https://weblizar.com/themes/enigma-premium/">Buy
                                Now</a>
                        </div>
                    </div>
                </div>
        ...
        <div id="pluginsd" class="tab-pane fade">
            ...
            <div class="   p_plugin blog_gallery clearfix clearfix">
                <div class="col-xs-12 col-sm-4 col-md-5 p_plugin_pic">
                    <div class="img-thumbnail">
                        <img src="<?php echo RPGP_PLUGIN_URL . 'images/Clockin-Pro.jpg'; ?>" class="img-responsive"
                             alt="img"/>
                ...
                <div class="  p_plugin_pic">
                    ...
                    <div class="btn-group-vertical">
                        <a target="_blank" class="btn btn-primary btn-lg"
                           href="https://weblizar.com/plugins/clockin-pro-plugin/">Demo</a>
                        <a class="btn btn-success btn-lg" href="https://weblizar.com/plugins/clockin-pro-plugin/">Buy
                            Now</a>
                    </div>
                </div>
            </div>
            ...
            <div class="   p_plugin blog_gallery clearfix clearfix">
                <div class="col-xs-12 col-sm-4 col-md-5 p_plugin_pic">
                    <div class="img-thumbnail">
                        <div class="img-thumbnail">
                            <img src="<?php echo RPGP_PLUGIN_URL . 'images/facebook-feed.jpg'; ?>"
                ...
                <div class="  p_plugin_pic">
                    ...
                    <div class="btn-group-vertical">
                        <a target="_blank" class="btn btn-primary btn-lg"
                           href="https://weblizar.com/plugins/facebook-feed-pro/">Demo</a>
                        <a class="btn btn-success btn-lg" href="https://weblizar.com/plugins/facebook-feed-pro/">Buy
                            Now</a>
                    </div>
                </div>
            </div>
            <div class="   p_plugin blog_gallery clearfix clearfix">
                <div class="col-xs-12 col-sm-4 col-md-5 p_plugin_pic">
                    <div class="img-thumbnail">
                        <img src="<?php echo RPGP_PLUGIN_URL . 'images/Pinterest-Feed.jpg'; ?>" class="img-responsive"
                             alt="img"/>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-5 col-md-5 p_plugin_desc">
                ...
                <div class="  p_plugin_pic">
                    ...
                    <div class="btn-group-vertical">
                        <a target="_blank" class="btn btn-primary btn-lg"
                           href="https://weblizar.com/plugins/pinterest-feed-pro/">Demo</a>
                        <a class="btn btn-success btn-lg" href="https://weblizar.com/plugins/pinterest-feed-pro/">Buy
                            Now</a>
                    </div>
                </div>
            </div>
            <div class="   p_plugin blog_gallery clearfix clearfix">
                <div class="col-xs-12 col-sm-4 col-md-5 p_plugin_pic">
                    <div class="img-thumbnail">
                        <img src="<?php echo RPGP_PLUGIN_URL . 'images/Search-Engine-Optimizer-new.jpg'; ?>"
                             class="img-responsive" alt="img"/>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-5 col-md-5 p_plugin_desc">
                ...
                <div class="  p_plugin_pic">
                    ...
                    <div class="btn-group-vertical">
                        <a target="_blank" class="btn btn-primary btn-lg"
                           href="https://weblizar.com/seo-image-optimizer-pro">Demo</a>
                        <a class="btn btn-success btn-lg" href="https://weblizar.com/seo-image-optimizer-pro/">Buy
                            Now</a>
                    </div>
                </div>
            </div>
            ...
            <div class="   p_plugin blog_gallery clearfix clearfix">
                <div class="col-xs-12 col-sm-4 col-md-5 p_plugin_pic">
                    <div class="img-thumbnail">
                        <img src="<?php echo RPGP_PLUGIN_URL . 'images/newsletter.png'; ?>" class="img-responsive"
                             alt="img"/>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-5 col-md-5 p_plugin_desc">
                ...
                <div class="  p_plugin_pic">
                    ...
                    <div class="btn-group-vertical">
                        <a target="_blank" class="btn btn-primary btn-lg"
                           href="https://weblizar.com/newsletter-subscription-form-pro/">Demo</a>
                        <a class="btn btn-success btn-lg" href="https://weblizar.com/newsletter-subscription-form-pro/">Buy
                            Now</a>
                    </div>
                </div>
            </div>
            ...
            <div class="   p_plugin blog_gallery clearfix clearfix">
                <div class="col-xs-12 col-sm-4 col-md-5 p_plugin_pic">
                    <div class="img-thumbnail">
                        <img src="<?php echo RPGP_PLUGIN_URL . 'images/Comingsoon.jpg'; ?>" class="img-responsive"
                             alt="img"/>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-5 col-md-5 p_plugin_desc">
                ...
                <div class="  p_plugin_pic">
                    ...
                    <div class="btn-group-vertical">
                        <a target="_blank" class="btn btn-primary btn-lg"
                           href="https://weblizar.com/plugins/coming-soon-page-maintenance-mode-pro/">Demo</a>
                        <a class="btn btn-success btn-lg"
                           href="https://weblizar.com/plugins/coming-soon-page-maintenance-mode-pro/">Buy Now</a>
                    </div>
                </div>
            </div>
            <div class="  p_plugin blog_gallery clearfix">
                <div class="col-xs-12 col-sm-4 col-md-5 p_plugin_pic">
                    <div class="img-thumbnail">
                        <img src="<?php echo RPGP_PLUGIN_URL . 'images/responsive-pro.jpg'; ?>" class="img-responsive"
                             alt="img"/>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-5 col-md-5 p_plugin_desc">
                ...
                <div class="  p_plugin_pic">
                    ...
                    <div class="btn-group-vertical">
                        ...
                        <a class="btn btn-success btn-lg" href="https://weblizar.com/plugins/responsive-portfolio-pro/">Buy
                            Now</a>
                    </div>
                </div>
            </div>
        ...
        <div id="offers" class="tab-pane fade">
            <div class="space  theme active">
                ...
                <div class="  p_plugin blog_gallery clearfix">
                    <div class="col-xs-12 col-sm-4 col-md-5 p_plugin_pic">
                        <div class="img-thumbnail">
                            <img src="<?php echo RPGP_PLUGIN_URL . 'images/offer.jpg'; ?>" class="img-responsive"
                                 alt="img"/>
                    ...
                    <div class="col-xs-12 col-sm-5 col-md-5 p_plugin_desc">
                        <div class=" p-box">
                            <h2>Get the Exciting Deals here , Daily</h2>
                        </div>
                    </div>
                    <div class="  p_plugin_pic">

                        <div class="btn-group-vertical">
                            <a class="btn btn-primary  btn-lg title_offers" href="https://weblizar.com/offers/">Visit
                                Here</a>
                        </div>
                    </div>
                </div>
...
<style>
    ...
    #weblizar-generator.weblizar-generator-narrow {
        max-width: none;
    }

    /* Generator tools */
    #weblizar-generator-tools {
    ...
    #weblizar-generator-tools a.weblizar-add-ons:hover {
        background: #ff4d21;
    }
    ...
    #weblizar-generator-choices span:hover i {
        color: #fff;
    }
    ...
    .weblizar-generator-attr-desc b {
        color: #999;
    }
    ...
    /* Upload fields */
    .weblizar-generator-field-actions {
        padding-top: 10px;
    }

    .weblizar-generator-field-actions .button,
    .weblizar-generator-field-actions span {
        margin-right: 5px;
    }
    ...
    *:first-child + html .clearfix {
    ...
    #shortcode-editor textarea {
        ...
        margin-bottom: 2%;
        font-size: 14px;
        box-shadow: 3px 5px 6px rgba(0, 0, 0, 0.12), 0px -5px 35px rgba(255, 255, 255, 0.84);
    }

    #shortcode-editor input:focus,
    #shortcode-editor textarea:focus {
        background: #fff;
    ...
    #shortcode-editor .form-section {
        margin-bottom: 20px;
    }

    #wpex-shortcodes-popup h2 {
        margin-bottom: 20px;
        fontsize: 14px;
        color: #333;
