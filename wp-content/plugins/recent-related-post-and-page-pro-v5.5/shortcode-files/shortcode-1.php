<style>
	...
	#r_r_post_title_<?php echo esc_attr($p_o_s_t);?>
	{
		...
		<?php if($featured_image_1=="none") { echo 'margin-left: 10px; margin-right: 10px;';}?>
	}
	...
	{
		<?php if($featured_image_1=="none") { echo 'margin-left: 10px !important; margin-right: 10px !important;';}?>
	}
	...
	#r_r_post_image_<?php echo esc_attr($p_o_s_t).$a?>.activity_rounded
	{
		...
		-webkit-border-radius: <?php echo $layout_1?>% !important;
		-moz-border-radius:<?php echo $layout_1?>% !important;
		border-radius: <?php echo $layout_1?>% !important;
		-khtml-border-radius:<?php echo $layout_1?>% !important;
		border:<?php echo esc_attr($bdr_size_1);?>px <?php echo esc_attr($img_bdr_type_1); ?> <?php echo esc_attr($img_bdr_color_1);?> !important;
	}
...
<div id="slider_div_<?php echo esc_attr($p_o_s_t).$a; ?>" class="vticker_<?php echo esc_attr($p_o_s_t).$a; ?> rps_main-div ">
	<?php
// The Query
	...
	<div  id="outer_div_<?php echo esc_attr($p_o_s_t); ?>"   style="width:100%">
		...
		if ( $the_query->have_posts() )
		{
			...
			<div id="mytemplate_<?php echo esc_attr($p_o_s_t); ?>" >
				...
				<?php  if($featured_image_1=="default"){ $my_image; }   if($featured_image_1=="upload"){$my_image=$user_image_1; }  if($featured_image_1=="none"){$my_image=""; } ?>
				<?php if(!$my_image==''){?>
