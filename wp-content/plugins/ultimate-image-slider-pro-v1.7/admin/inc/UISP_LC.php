 ...
 *    $checker = new UISP_LicenseChecker($_GET['license_key']);
 ...
 *     $checker = new UISP_LicenseChecker(file_get_contents('license_key.php'));
...
class UISP_LC 
{
    ...
    /** @var UISP_LicenseChecker_ActivationResponse */
     ...
     * @return \UISP_LicenseChecker_ActivationResponse
     */
    protected function processActivationResponse($resp)
    {
        $response = new UISP_LicenseChecker_ActivationResponse($resp);
    ...
    {
        $ret = new UISP_LicenseChecker_ActivationResponse;
        if (empty($response)) 
            return $ret;
        $c = new UISP_Crypt_Blowfish($this->_local_encryption_key);
        try {
...
class UISP_LicenseChecker_ActivationResponse
{
    public $code;
    public $message;
...
class UISP_Crypt_Blowfish
{
    ...
    function _init()
    {
        $defaults = new UISP_Crypt_Blowfish_DefaultKey();
        $this->_P = $defaults->P;
        $this->_S = $defaults->S;
    }
...
class UISP_Crypt_Blowfish_DefaultKey
{
    var $P = array();
