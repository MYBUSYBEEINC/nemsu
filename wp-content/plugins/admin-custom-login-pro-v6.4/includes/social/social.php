...
<script>
    ...
    jQuery(document).ready(function () {
        //Enable Social Icon
        jQuery("#enable_social_icon").val('<?php if ( $enable_social_icon != "" ) {
			echo $enable_social_icon;
		} else {
			echo "";
		}?>');
    });
...
<div class="row">
                    ...
                    <div class="post-social post-social-xs" id="post-social-5">
                        <div class="text-center padding-all text-center">
                            <div class="textbox text-white   margin-bottom settings-title">
								<?php _e( 'Social Settings', WEBLIZAR_ACL_PRO ) ?>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="panel panel-primary panel-default content-panel">
        <div class="panel-body">
            <table class="form-table">
                <tr>
                    <th scope="row"><?php _e( 'Enable Social Icons', WEBLIZAR_ACL_PRO ) ?></th>
                    <td></td>
                </tr>
                <tr class="radio-span" style="border-bottom:none;">
                    <td>
                        <select id="enable_social_icon" class="standard-dropdown" name="enable_social_icon">
                            <option value="no-icon"><?php _e( 'No Icon', WEBLIZAR_ACL_PRO ) ?></option>
                            <option value="inner"><?php _e( 'Inner', WEBLIZAR_ACL_PRO ) ?></option>
                            <option value="outer"><?php _e( 'Outer', WEBLIZAR_ACL_PRO ) ?></option>
                            <option value="both"><?php _e( 'Both', WEBLIZAR_ACL_PRO ) ?></option>
                        </select>
                    </td>
                </tr>
            </table>
    ...
    <div class="panel panel-primary panel-default content-panel">
        <div class="panel-body">
            <table class="form-table">
                <tr>
                    <th scope="row"><?php _e( 'Social Media Icon Size', WEBLIZAR_ACL_PRO ) ?></th>
                    <td></td>
                </tr>
                <tr class="radio-span" style="border-bottom:none;">
                    <td>
						<span>
							<input type="radio" name="social_size" value="small"
                                   id="social_size1" <?php if ( $social_icon_size == "small" ) {
								echo "checked";
							} ?> />&nbsp;<?php _e( 'Small', WEBLIZAR_ACL_PRO ) ?><br>
						</span>
                        <span>
							<input type="radio" name="social_size" value="mediam"
                                   id="social_size2" <?php if ( $social_icon_size == "mediam" ) {
								echo "checked";
							} ?> />&nbsp;<?php _e( 'Medium', WEBLIZAR_ACL_PRO ) ?><br>
						</span>
                        <span>
							<input type="radio" name="social_size" value="large"
                                   id="social_size3" <?php if ( $social_icon_size == "large" ) {
								echo "checked";
							} ?> />&nbsp;<?php _e( 'Large', WEBLIZAR_ACL_PRO ) ?><br>
						</span>
                    </td>
                </tr>
            </table>
    ...
    <div class="panel panel-primary panel-default content-panel">
        <div class="panel-body">
            <table class="form-table">
                <tr>
                    <th scope="row"><?php _e( 'Social Media Icon Layout', WEBLIZAR_ACL_PRO ) ?></th>
                    <td></td>
                </tr>
                <tr class="radio-span" style="border-bottom:none;">
                    <td>
						<span>
							<input type="radio" name="social_layout" value="rectangle"
                                   id="social_layout1" <?php if ( $social_icon_layout == "rectangle" ) {
								echo "checked";
							} ?> />&nbsp;<?php _e( 'Rectangle', WEBLIZAR_ACL_PRO ) ?><br>
						</span>
                        <span>
							<input type="radio" name="social_layout" value="circle"
                                   id="social_layout2" <?php if ( $social_icon_layout == "circle" ) {
								echo "checked";
							} ?> />&nbsp;<?php _e( 'Circle', WEBLIZAR_ACL_PRO ) ?><br>
						</span>
                    </td>
                </tr>
            </table>
    ...
    <div class="panel panel-primary panel-default content-panel">
        <div class="panel-body">
            <table class="form-table">
                <tr>
                    <th scope="row"><?php _e( 'Social Media Icon Color', WEBLIZAR_ACL_PRO ) ?></th>
                    <td></td>
                </tr>
                <tr style="border-bottom:none;">
                    <td>
                        <input id="social-icon-color" name="background-color" type="text"
                               value="<?php echo $social_icon_color; ?>" class="my-color-field"
    ...
    <div class="panel panel-primary panel-default content-panel">
        <div class="panel-body">
            <table class="form-table">
                <tr>
                    <th scope="row"><?php _e( 'Social Media Icon Color On Hover', WEBLIZAR_ACL_PRO ) ?></th>
                    <td></td>
                </tr>
                <tr style="border-bottom:none;">
                    <td>
                        <input id="social-icon-color-onhover" name="background-color" type="text"
                               value="<?php echo $social_icon_color_onhover; ?>" class="my-color-field"
                               data-default-color="#ffffff"/>
                    </td>
                </tr>
            </table>
    ...
    <div class="panel panel-primary panel-default content-panel">
        <div class="panel-body">
            <table class="form-table">
                <tr>
                    <th scope="row"><?php _e( 'Social Media Icon Background Color', WEBLIZAR_ACL_PRO ) ?></th>
                    <td></td>
                </tr>
                <tr style="border-bottom:none;">
                    <td>
                        <input id="social-bg-color" name="background-color" type="text"
                               value="<?php echo $social_icon_bg; ?>" class="my-color-field"
                               data-default-color="#ffffff"/>
                    </td>
                </tr>
            </table>
    ...
    <div class="panel panel-primary panel-default content-panel">
        <div class="panel-body">
            <table class="form-table">
                <tr>
                    <th scope="row"><?php _e( 'Social Media Background Color On Hover', WEBLIZAR_ACL_PRO ) ?></th>
                    <td></td>
                </tr>
                <tr style="border-bottom:none;">
                    <td>
                        <input id="social-bg-color-onhover" name="background-color" type="text"
                               value="<?php echo $social_icon_bg_onhover; ?>" class="my-color-field"
                               data-default-color="#ffffff"/>
                    </td>
                </tr>
            </table>
    ...
    <div class="panel panel-primary panel-default content-panel">
        <div class="panel-body">
            <table class="form-table">
                <tr>
                    <th scope="row" ><?php _e('Enable To Open Social Link In New Window', WEBLIZAR_ACL_PRO)?></th>
                    <td></td>
                </tr>
                ...
                <tr class="radio-span" style="border-bottom:none;">
                    <td>
                        <?php 
                            ...
                            ?>
                        <span>
                            <input type="radio" name="social_link_new_window" value="yes" id="social_link_new_window1" <?php if($social_link_new_window=="yes")echo "checked"; ?> <?php if(empty($social_link_new_window))echo "checked"; ?> />&nbsp;<?php _e('Yes', WEBLIZAR_ACL_PRO)?><br>
                        </span>
                        <span>
                            <input type="radio" name="social_link_new_window" value="no" id="social_link_new_window2" <?php if($social_link_new_window=="no")echo "checked"; ?> />&nbsp;<?php _e('No', WEBLIZAR_ACL_PRO)?><br>
                        </span>
                    </td>
                </tr>
            </table>
    ...
    <div class="panel panel-primary panel-default content-panel">
        <div class="panel-body">
            <table class="form-table">
                <tr>
                    <th scope="row"><?php _e( 'Social Profiles', WEBLIZAR_ACL_PRO ) ?></th>
                    <td></td>
                </tr>
                <tr class="radio-span" style="border-bottom:none;">
                    <td>
                        <p class="rcsp_p_admin"><?php _e( 'Enter your social profiles complete url here', WEBLIZAR_ACL_PRO ) ?></p>
                        <ul class="rcp_social_profile_admin">
                            <li><i class="fab fa-facebook-f"></i><input type="text" class="pro_text" id="facebook-link"
                                                                        name="facebook-link"
                                                                        placeholder="<?php _e( 'Facebook', WEBLIZAR_ACL_PRO ) ?>"
                                                                        size="56"
                                                                        value="<?php echo $social_facebook_link; ?>"/>
                            </li>
                            <li><i class="fab fa-twitter"></i><input type="text" class="pro_text" id="twitter-link"
                                                                     name="twitter-link"
                                                                     placeholder="<?php _e( 'Twitter', WEBLIZAR_ACL_PRO ) ?>"
                                                                     size="56"
                                                                     value="<?php echo $social_twitter_link; ?>"/></li>
                            <li><i class="fab fa-linkedin-in"></i><input type="text" class="pro_text" id="linkedin-link"
                                                                         name="linkedin-link"
                                                                         placeholder="<?php _e( 'Linkedin', WEBLIZAR_ACL_PRO ); ?>"
                                                                         size="56"
                                                                         value="<?php echo $social_linkedin_link; ?>"/>
                            </li>
                            <li><i class="fab fa-google-plus-g"></i><input type="text" class="pro_text"
                                                                           id="google-plus-link" name="google-plus-link"
                                                                           placeholder="<?php _e( 'Google Plus', WEBLIZAR_ACL_PRO ); ?>"
                                                                           size="56"
                                                                           value="<?php echo $social_google_plus_link; ?>"/>
                            </li>
                            <li><i class="fab fa-pinterest-p"></i><input type="text" class="pro_text"
                                                                         id="pinterest-link" name="pinterest-link"
                                                                         placeholder="<?php _e( 'Pinterest', WEBLIZAR_ACL_PRO ); ?>"
                                                                         size="56"
                                                                         value="<?php echo $social_pinterest_link; ?>"/>
                            </li>
                            <li><i class="fab fa-digg"></i><input type="text" class="pro_text" id="digg-link"
                                                                  name="digg-link"
                                                                  placeholder="<?php _e( 'Digg', WEBLIZAR_ACL_PRO ) ?>"
                                                                  size="56" value="<?php echo $social_digg_link; ?>"/>
                            </li>
                            <li><i class="fab fa-youtube-square"></i><input type="text" class="pro_text"
                                                                            id="youtube-link" name="youtube-link"
                                                                            placeholder="<?php _e( 'Youtube', WEBLIZAR_ACL_PRO ) ?>"
                                                                            size="56"
                                                                            value="<?php echo $social_youtube_link; ?>"/>
                            </li>
                            <li><i class="fab fa-flickr"></i><input type="text" class="pro_text" id="flickr-link"
                                                                    name="flickr-link"
                                                                    placeholder="<?php _e( 'Flickr', WEBLIZAR_ACL_PRO ) ?>"
                                                                    size="56"
                                                                    value="<?php echo $social_flickr_link; ?>"/></li>
                            <li><i class="fab fa-tumblr"></i><input type="text" class="pro_text" id="tumblr-link"
                                                                    name="tumblr-link"
                                                                    placeholder="<?php _e( 'Tumblr', WEBLIZAR_ACL_PRO ) ?>"
                                                                    size="56"
                                                                    value="<?php echo $social_tumblr_link; ?>"/></li>
                            <li><i class="fab fa-skype"></i><input type="text" class="pro_text" id="skype-link"
                                                                   name="skype-link"
                                                                   placeholder="<?php _e( 'Skype', WEBLIZAR_ACL_PRO ) ?>"
                                                                   size="56" value="<?php echo $social_skype_link; ?>"/>
                            </li>
                            <li><i class="fab fa-instagram"></i><input type="text" class="pro_text" id="instagram-link"
                                                                       name="instagram-link"
                                                                       placeholder="<?php _e( 'Instagram', WEBLIZAR_ACL_PRO ) ?>"
                                                                       size="56"
                                                                       value="<?php echo $social_instagram_link; ?>"/>
                            </li>
                            <li><i class="fab fa-telegram-plane"></i><input type="text" class="pro_text"
                                                                            id="telegram-link" name="telegram-link"
                                                                            placeholder="<?php _e( 'Telegram', WEBLIZAR_ACL_PRO ) ?>"
                                                                            size="56"
                                                                            value="<?php echo $social_telegram_link; ?>"/>
                            </li>
                            <li><i class="fab fa-whatsapp"></i><input type="text" class="pro_text" id="whatsapp-link"
                                                                      name="whatsapp-link"
                                                                      placeholder="<?php _e( 'Whatsapp', WEBLIZAR_ACL_PRO ) ?>"
                                                                      size="56"
                                                                      value="<?php echo $social_whatsapp_link; ?>"/>
                            </li>
                        </ul>
                    </td>
                </tr>
    ...
    <div id="somedialog5" class="dialog" style="position: fixed; z-index: 9999;">
        ...
        <div class="dialog__content">
            ...
            <div class="dialog-inner">
                <h2>
                    <strong><?php _e( 'Social', WEBLIZAR_ACL_PRO ) ?></strong> <?php _e( 'Setting Save Successfully', WEBLIZAR_ACL_PRO ) ?>
                </h2>
                <div>
                    <button class="action dialog-button-close" data-dialog-close
                            id="dialog-close-button5"><?php _e( 'Close', WEBLIZAR_ACL_PRO ) ?></button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="somedialog6" class="dialog" style="position: fixed; z-index: 9999;">
        ...
        <div class="dialog__content">
            ...
            <div class="dialog-inner">
                <h2>
                    <strong><?php _e( 'Social', WEBLIZAR_ACL_PRO ) ?></strong> <?php _e( 'Setting Reset Successfully', WEBLIZAR_ACL_PRO ) ?>
                </h2>
                <div>
                    <button class="action dialog-button-close" data-dialog-close
                            id="dialog-close-button6"><?php _e( 'Close', WEBLIZAR_ACL_PRO ) ?></button>
                </div>
            </div>
        </div>
    </div>
    <div class="panel panel-primary save-button-block">
        <div class="panel-body">
            <div class="pull-left">
                <button type="button" onclick="return Custom_login_social('socialSave', '');"
                        class="btn btn-info btn-lg"><?php _e( 'Save Changes', WEBLIZAR_ACL_PRO ) ?></button>
            </div>
            <div class="pull-right">
                <button type="button" onclick="return Custom_login_social('socialReset', '');"
