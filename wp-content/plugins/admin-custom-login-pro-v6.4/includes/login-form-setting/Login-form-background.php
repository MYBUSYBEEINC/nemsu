...
<script>
    ...
    jQuery(function () {
        ...
        jQuery("#login-opacity-slider").slider("value",<?php if ( $login_form_opacity != "" ) {
			echo $login_form_opacity;
		} else {
			echo "10";
		}?>);
    ...
    jQuery(function () {
        ...
        jQuery("#button-size-slider4").slider("value",<?php if ( $login_form_width != "" ) {
			echo $login_form_width;
		} else {
			echo "300";
		}?>);
    ...
    jQuery(function () {
        ...
        jQuery("#button_left").slider("value",<?php if ( $login_form_left != "" ) {
			echo $login_form_left;
		} else {
			echo "700";
		}?>);
    ...
    jQuery(function () {
        ...
        jQuery("#button_top").slider("value",<?php if ( $login_form_top != "" ) {
			echo $login_form_top;
		} else {
			echo "300";
		}?>);
    ...
    jQuery(function () {
        ...
        jQuery("#button-size-slider5").slider("value",<?php if ( $login_form_radius != "" ) {
			echo $login_form_radius;
		} else {
			echo "3";
		}?> );
    ...
    jQuery(function () {
        ...
        jQuery("#button-size-slider6").slider("value",<?php if ( $login_border_thikness != "" ) {
			echo $login_border_thikness;
		} else {
			echo "3";
		}?> );
    ...
    jQuery(function () {
        ...
        jQuery("#button-msg-font-resizer").slider("value",<?php if ( $login_msg_fontsize != "" ) {
			echo $login_msg_fontsize;
		} else {
			echo "16";
		}?> );
    ...
    jQuery(document).ready(function () {
        ...
        jQuery("#select-login-bg").val('<?php if ( $login_bg_type != "" ) {
			echo $login_bg_type;
		} else {
			echo "";
		}?>');
        ...
        jQuery("#login_bg_color_overlay").val('<?php if ( $login_bg_effect != "" ) {
			echo $login_bg_effect;
		} else {
			echo "";
		}?>');
        //login border style
        jQuery("#login_border_style").val('<?php if ( $login_border_style != "" ) {
			echo $login_border_style;
		} else {
			echo "";
		}?>');
        //login Background Repeat
        jQuery("#login_bg_repeat").val('<?php if ( $login_bg_repeat != "" ) {
			echo $login_bg_repeat;
		} else {
			echo "";
		}?>');
        //login Background Position
        jQuery("#login_bg_position").val('<?php if ( $login_bg_position != "" ) {
			echo $login_bg_position;
		} else {
			echo "";
		}?>');
    });
...
<div class="row">
                    ...
                    <div class="post-social post-social-xs" id="post-social-5">
                        <div class="text-center padding-all text-center">
                            <div class="textbox text-white   margin-bottom settings-title">
								<?php _e( 'Login Settings', WEBLIZAR_ACL_PRO ); ?>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="panel panel-primary panel-default content-panel">
        <div class="panel-body">
            <table class="form-table">
                <tr>
                    <th scope="row"><?php _e( 'Login Form Position', WEBLIZAR_ACL_PRO ); ?></th>
                    <td></td>
                </tr>
                <tr class="radio-span" style="border-bottom:none;">
                    <td>
                        <select id="login_form_position" name="login_form_position" class="standard-dropdown"
                                onchange='form_position_change()'>
                            <option value="default" <?php if ( $login_form_position == "default" ) {
								echo "selected";
							} ?>><?php _e( 'Default', WEBLIZAR_ACL_PRO ); ?></option>
                            <option value="lf_float_style" <?php if ( $login_form_position == "lf_float_style" ) {
								echo "selected";
							} ?>><?php _e( 'Floating', WEBLIZAR_ACL_PRO ); ?></option>
                            <option value="lf_customize_style" <?php if ( $login_form_position == "lf_customize_style" ) {
								echo "selected";
							} ?>><?php _e( 'Floating With Customization', WEBLIZAR_ACL_PRO ); ?></option>
                        </select>
                    </td>
                </tr>
            </table>
    ...
    <div id="div-login-float" class="lf_float_style" style="display:none;">
        <table class="form-table">
            <tr>
                <th scope="row"><?php _e( 'Float Settings', WEBLIZAR_ACL_PRO ); ?></th>
                <td></td>
            </tr>
            <tr class="radio-span" style="border-bottom:none;">
                <td>
					<span>
						<input type="radio" name="login_form_float" value="left"
                               id="login_form_float" <?php if ( $login_form_float == "left" ) {
							echo "checked";
						} ?> />&nbsp;<?php _e( 'Left', WEBLIZAR_ACL_PRO ) ?><br>
					</span>
                    <span>
						<input type="radio" name="login_form_float" value="center"
                               id="login_form_float" <?php if ( $login_form_float == "center" ) {
							echo "checked";
						} ?> />&nbsp;<?php _e( 'Center', WEBLIZAR_ACL_PRO ) ?><br>
					</span>
                    <span>
						<input type="radio" name="login_form_float" value="right"
                               id="login_form_float" <?php if ( $login_form_float == "right" ) {
							echo "checked";
						} ?> />&nbsp;<?php _e( 'Right', WEBLIZAR_ACL_PRO ) ?><br>
					</span>
                </td>
            </tr>
        </table>
    ...
    <div id="div-login-custom" class="lf_customize_style" style="display:none;">
        <table class="form-table">
            <tr>
                <th scope="row"><?php _e( 'Floating With Customization Settings', WEBLIZAR_ACL_PRO ); ?></th>
                <td></td>
            </tr>
            <tr style="border-bottom:none;">
                <td>
                    ...
                    <input type="text" class="slider-text" id="login_form_left" name="login_form_left"
                           readonly="readonly">
            ...
            <tr>
                <td>
                    ...
                    <input type="text" class="slider-text" id="login_form_top" name="login_form_top"
                           readonly="readonly">
                    <span class="slider-text-span">Px</span>
                </td>
            </tr>
            <tr>
                <td>
                    <p><?php _e( 'Note: This form position setting will be not responsive.', WEBLIZAR_ACL_PRO ); ?></p>
                </td>
            </tr>
        </table>
    </div>
    ...
    <div class="panel panel-primary panel-default content-panel">
        <div class="panel-body">
            <table class="form-table">
                <tr>
                    <th scope="row"><?php _e( 'Select Background', WEBLIZAR_ACL_PRO ); ?></th>
                    <td></td>
                </tr>
                <tr class="radio-span" style="border-bottom:none;">
                    <td>
                        <select id="select-login-bg" class="standard-dropdown" name="select-background"
                                onchange='loginbgchange()'>
                            <optgroup label="<?php _e( 'Select background', WEBLIZAR_ACL_PRO ); ?>">
                                <option value="static-background-color"><?php _e( 'Static Background Color', WEBLIZAR_ACL_PRO ); ?></option>
                                <option value="static-background-image"><?php _e( 'Static Background Image', WEBLIZAR_ACL_PRO ); ?></option>
                            </optgroup>
                        </select>
                    </td>
                </tr>
    ...
    <div id="div-login-bg-color" class="no-login-bg">
        <div style="margin-bottom: 10px;">
            <img src="<?php echo WEBLIZAR_ACL_PLUGIN_URL_PRO . '/images/background-color1.png'; ?>"
                 class="img-responsive" style="margin-right: auto;" alt="">
        </div>
        <div class="panel panel-primary panel-default content-panel">
            <div class="panel-body">
                <table class="form-table">
                    <tr>
                        <th scope="row"><?php _e( 'Background Color', WEBLIZAR_ACL_PRO ); ?></th>
                        <td></td>
                    </tr>
                    <tr style="border-bottom:none;">
                        <td id="td-login-background-color">
                            <input id="login-background-color" name="login-background-color" type="text"
                                   value="<?php echo $login_bg_color; ?>" class="my-color-field"
        ...
        <div class="panel panel-primary panel-default content-panel">
            <div class="panel-body">
                <table class="form-table">
                    <tr>
                        <th scope="row"><?php _e( 'Login Form Opacity', WEBLIZAR_ACL_PRO ) ?></th>
                        <td></td>
                    </tr>
                    <tr style="border-bottom:none;">
                        <td>
                            <div id="login-opacity-slider" class="size-slider"
                                 style="width: 30%;display:inline-block"></div>
                            <input type="text" class="slider-text" id="login-opacity-text-box"
                                   name="login-opacity-text-box" readonly="readonly">
                            <span class="slider-text-span">Px</span>
                        </td>
                    </tr>
                </table>
    ...
    <div id="div-login-bg-image" class="no-login-bg">
        <div style="margin-bottom: 10px;">
            <img src="<?php echo WEBLIZAR_ACL_PLUGIN_URL_PRO . '/images/background-image.png'; ?>"
                 class="img-responsive" style="margin-right: auto;">
        </div>
        <div class="panel panel-primary panel-default content-panel">
            <div class="panel-body">
                <table class="form-table">
                    <tr>
                        <th scope="row"><?php _e( 'Background Image', WEBLIZAR_ACL_PRO ) ?></th>
                        <td></td>
                    </tr>
                    <tr style="border-bottom:none;">
                        <td>
                            <input type="text" class="pro_text" id="login_bg_image"
                                   placeholder="<?php _e( 'No media selected!', WEBLIZAR_ACL_PRO ) ?>"
                                   name="upload_image" disabled="disabled" value="<?php echo $login_bg_image; ?>"/>
                            <input type="button" value="<?php _e( 'Upload', WEBLIZAR_ACL_PRO ) ?>" id="upload-logo"
                                   class="button-primary rcsp_media_upload"/>

                            <input type="button" value="<?php _e( 'Preview', WEBLIZAR_ACL_PRO ) ?>" data-toggle="modal"
                                   data-target="#about_us_image_builder" id="login-image-previewer"
                                   title="Font Awesome Icons" class="button  " onclick="Acl_show_Image_2()"/>

                            <input type="button" id="display-logo" value="<?php _e( 'Remove', WEBLIZAR_ACL_PRO ) ?>"
                                   class="button " onclick="Acl_login_img_clear();"/>

                            <!-- Modal -->
                            <div class="modal " id="about_us_image_builder" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title"
                                                id="myModalLabel"><?php _e( 'Login Background Image', WEBLIZAR_ACL_PRO ) ?></h4>
                                        </div>
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-default"
                                                    data-dismiss="modal"><?php _e( 'Close', WEBLIZAR_ACL_PRO ) ?></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="panel panel-primary panel-default content-panel">
            <div class="panel-body">
                <table class="form-table">
                    <tr>
                        <th scope="row"><?php _e( 'Background Repeat', WEBLIZAR_ACL_PRO ) ?></th>
                        <td></td>
                    </tr>
                    <tr class="radio-span" style="border-bottom:none;">
                        <td>
                            <select id="login_bg_repeat" class="standard-dropdown" name="login_bg_repeat">
                                <option value="no-repeat"><?php _e( 'No Repeat', WEBLIZAR_ACL_PRO ) ?></option>
                                <option value="repeat"><?php _e( 'Repeat', WEBLIZAR_ACL_PRO ) ?></option>
                                <option value="repeat-x"><?php _e( 'Repeat Horizontally', WEBLIZAR_ACL_PRO ) ?></option>
                                <option value="repeat-y"><?php _e( 'Repeat Vertically', WEBLIZAR_ACL_PRO ) ?></option>
                            </select>
                        </td>
                    </tr>
                </table>
        ...
        <div class="panel panel-primary panel-default content-panel">
            <div class="panel-body">
                <table class="form-table">
                    <tr>
                        <th scope="row"><?php _e( 'Background Position', WEBLIZAR_ACL_PRO ) ?></th>
                        <td></td>
                    </tr>
                    <tr class="radio-span" style="border-bottom:none;">
                        <td>
                            <select id="login_bg_position" class="standard-dropdown" name="login_bg_position">
                                <option value="left top"><?php _e( 'Left Top', WEBLIZAR_ACL_PRO ) ?> </option>
                                <option value="left center"><?php _e( 'Left Center', WEBLIZAR_ACL_PRO ) ?> </option>
                                <option value="left bottom"><?php _e( 'Left Bottom', WEBLIZAR_ACL_PRO ) ?> </option>
                                <option value="right top"><?php _e( 'Right Top', WEBLIZAR_ACL_PRO ) ?> </option>
                                <option value="right center"><?php _e( 'Right Center', WEBLIZAR_ACL_PRO ) ?> </option>
                                <option value="right bottom"><?php _e( 'Right Bottom', WEBLIZAR_ACL_PRO ) ?></option>
                                <option value="center top"><?php _e( 'Center Top', WEBLIZAR_ACL_PRO ) ?> </option>
                                <option value="center"><?php _e( 'Center Center', WEBLIZAR_ACL_PRO ) ?> </option>
                                <option value="center bottom"><?php _e( 'Center Bottom', WEBLIZAR_ACL_PRO ) ?> </option>
                            </select>
                        </td>
                    </tr>
                </table>
    ...
    <div class="panel panel-primary panel-default content-panel">
        <div class="panel-body">
            <table class="form-table">
                <tr>
                    <th scope="row"><?php _e( 'Background Effect', WEBLIZAR_ACL_PRO ) ?></th>
                    <td></td>
                </tr>
                <tr class="radio-span" style="border-bottom:none;">
                    <td>
                        <select id="login_bg_color_overlay" class="standard-dropdown" name="login_bg_color_overlay">
                            <optgroup label="<?php _e( 'Select overlay effect', WEBLIZAR_ACL_PRO ) ?>">
                                <option value="no_effect"><?php _e( 'No Overlay Effect', WEBLIZAR_ACL_PRO ) ?></option>
                                <option value="pattern-1"><?php _e( 'Overlay Effect 1', WEBLIZAR_ACL_PRO ) ?> </option>
                                <option value="pattern-2"><?php _e( 'Overlay Effect 2', WEBLIZAR_ACL_PRO ) ?> </option>
                                <option value="logo"><?php _e( 'Overlay Effect 3', WEBLIZAR_ACL_PRO ) ?> </option>
                            </optgroup>
                        </select>
                    </td>
                </tr>
    ...
    <div class="panel panel-primary panel-default content-panel">
        <div class="panel-body">
            <table class="form-table">
                <tr>
                    <th scope="row"><?php _e( 'Login Form Width', WEBLIZAR_ACL_PRO ) ?></th>
                    <td></td>
                </tr>
                <tr style="border-bottom:none;">
                    <td>
                        <div id="button-size-slider4" class="size-slider" style="width: 30%;display:inline-block"></div>
                        <input type="text" class="slider-text" id="login-width-text-box" name="login-width-text-box"
                               readonly="readonly">
                        <span class="slider-text-span">Px</span>
                    </td>
                </tr>
    ...
    <div class="panel panel-primary panel-default content-panel">
        <div class="panel-body">
            <table class="form-table">
                <tr>
                    <th scope="row"><?php _e( 'Border Color', WEBLIZAR_ACL_PRO ) ?></th>
                    <td></td>
                </tr>
                <tr style="border-bottom:none;">
                    <td id="td-login-Border-color">
                        <input id="login-Border-color" name="login-Border-color" type="text"
                               value="<?php echo $login_border_color; ?>" class="my-color-field"
                               data-default-color="#ffffff"/>
                    </td>
                </tr>
            </table>
    ...
    <div class="panel panel-primary panel-default content-panel">
        <div class="panel-body">
            <table class="form-table">
                <tr>
                    <th scope="row"><?php _e( 'Border Radius', WEBLIZAR_ACL_PRO ) ?></th>
                    <td></td>
                </tr>
                <tr style="border-bottom:none;">
                    <td>
                        <div id="button-size-slider5" class="size-slider" style="width: 30%;display:inline-block"></div>
                        <input type="text" class="slider-text" id="login-Radius-text-box" name="login-Radius-text-box"
                               readonly="readonly">
                        <span class="slider-text-span">Px</span>
                    </td>
                </tr>
    ...
    <div class="panel panel-primary panel-default content-panel">
        <div class="panel-body">
            <table class="form-table">
                <tr>
                    <th scope="row"><?php _e( 'Border Style', WEBLIZAR_ACL_PRO ) ?></th>
                    <td></td>
                </tr>
                <tr class="radio-span" style="border-bottom:none;">
                    <td>
                        <select id="login_border_style" class="standard-dropdown" name="login_border_style">
                            <option value="none"><?php _e( 'None', WEBLIZAR_ACL_PRO ) ?> </option>
                            <option value="solid"><?php _e( 'Solid', WEBLIZAR_ACL_PRO ) ?> </option>
                            <option value="dotted"><?php _e( 'Dotted', WEBLIZAR_ACL_PRO ) ?> </option>
                            <option value="dashed"><?php _e( 'Dashed', WEBLIZAR_ACL_PRO ) ?> </option>
                            <option value="double"><?php _e( 'Double', WEBLIZAR_ACL_PRO ) ?> </option>
                        </select>
                    </td>
                </tr>
            </table>
    ...
    <div class="panel panel-primary panel-default content-panel">
        <div class="panel-body">
            <table class="form-table">
                <tr>
                    <th scope="row"><?php _e( 'Border Thickness', WEBLIZAR_ACL_PRO ) ?></th>
                    <td></td>
                </tr>
                <tr style="border-bottom:none;">
                    <td>
                        <div id="button-size-slider6" class="size-slider" style="width: 30%;display:inline-block"></div>
                        <input type="text" class="slider-text" id="login-thickness-text-box"
                               name="login-thickness-text-box" readonly="readonly">
                        <span class="slider-text-span">Px</span>
                    </td>
                </tr>
            </table>
    ...
    <div class="panel panel-primary panel-default content-panel">
        <div class="panel-body">
            <table class="form-table">
                <tr>
                    <th scope="row"><?php _e( 'Enable Form Shadow?', WEBLIZAR_ACL_PRO ) ?></th>
                    <td></td>
                </tr>
                <tr class="radio-span" style="border-bottom:none;">
                    <td>
						<span>
							<input type="radio" name="enable_form_shadow" value="yes"
                                   id="login_enable_shadow1" <?php if ( $login_enable_shadow == "yes" ) {
								echo "checked";
							} ?> />&nbsp;<?php _e( 'Yes', WEBLIZAR_ACL_PRO ) ?><br>
						</span>
                        <span>
							<input type="radio" name="enable_form_shadow" value="no"
                                   id="login_enable_shadow2" <?php if ( $login_enable_shadow == "no" ) {
								echo "checked";
							} ?> />&nbsp;<?php _e( 'No', WEBLIZAR_ACL_PRO ) ?><br>
						</span>
                    </td>
                </tr>
            </table>
    ...
    <div class="panel panel-primary panel-default content-panel">
        <div class="panel-body">
            <table class="form-table">
                <tr>
                    <th scope="row"><?php _e( 'Form Shadow Color', WEBLIZAR_ACL_PRO ) ?></th>
                    <td></td>
                </tr>
                <tr style="border-bottom:none;">
                    <td id="td_login_shadow_color">
                        <input id="login_shadow_color" name="login_shadow_color" type="text"
                               value="<?php echo $login_shadow_color; ?>" class="my-color-field"
                               data-default-color="#ffffff"/>
                    </td>
                </tr>
            </table>
    ...
    <div class="panel panel-primary panel-default content-panel">
        <div class="panel-body">
            <table class="form-table">
                <tr>
                    <th scope="row"><?php _e( 'Username or Email Field Label Text', WEBLIZAR_ACL_PRO ); ?></th>
                    <td></td>
                </tr>
                <tr style="border-bottom:none;">
                    <td>
                        <input type="text"
                               placeholder="<?php _e( 'Type username or email field label text', WEBLIZAR_ACL_PRO ); ?>"
                               id="label_username" name="label_username"
                               value="<?php echo stripslashes( $label_username ); ?>" size="56">
                    </td>
                </tr>
            </table>
        </div>
    ...
    <div class="panel panel-primary panel-default content-panel">
        <div class="panel-body">
            <table class="form-table">
                <tr>
                    <th scope="row"><?php _e( 'Type Username and Placeholder Text', WEBLIZAR_ACL_PRO ); ?></th>
                    <td></td>
                </tr>
                <tr style="border-bottom:none;">
                    <td>
                        <input type="text" placeholder="<?php _e( 'Type Username or Email', WEBLIZAR_ACL_PRO ) ?>"
                               id="user_cust_lbl" name="user_cust_lbl" value="<?php echo $user_cust_lbl; ?>" size="56">
                    </td>
                </tr>
            </table>
        </div>
    ...
    <div class="panel panel-primary panel-default content-panel">
        <div class="panel-body">
            <table class="form-table">
                <tr>
                    <th scope="row"><?php _e( 'Password Field Label Text', WEBLIZAR_ACL_PRO ); ?></th>
                    <td></td>
                </tr>
                <tr style="border-bottom:none;">
                    <td>
                        <input type="text"
                               placeholder="<?php _e( 'Type password field label text', WEBLIZAR_ACL_PRO ); ?>"
                               id="label_password" name="label_password"
                               value="<?php echo stripslashes( $label_password ); ?>" size="56">
                    </td>
                </tr>
            </table>
        </div>
    ...
    <div class="panel panel-primary panel-default content-panel">
        <div class="panel-body">
            <table class="form-table">
                <tr>
                    <th scope="row"><?php _e( 'Password Label and Placeholder Text', WEBLIZAR_ACL_PRO ); ?></th>
                    <td></td>
                </tr>
                <tr style="border-bottom:none;">
                    <td>
                        <input type="text" placeholder="<?php _e( 'Type Password', WEBLIZAR_ACL_PRO ) ?>"
                               id="pass_cust_lbl" name="pass_cust_lbl" value="<?php echo $pass_cust_lbl; ?>" size="56">
                    </td>
                </tr>
            </table>
        </div>
    ...
    <div class="panel panel-primary panel-default content-panel">
        <div class="panel-body">
            <table class="form-table">
                <tr>
                    <th scope="row"><?php _e( 'Log In Button Text', WEBLIZAR_ACL_PRO ); ?></th>
                    <td></td>
                </tr>
                <tr style="border-bottom:none;">
                    <td>
                        <input type="text" placeholder="<?php _e( 'Type log in button text', WEBLIZAR_ACL_PRO ); ?>"
                               id="label_loginButton" name="label_loginButton"
                               value="<?php echo stripslashes( $label_loginButton ); ?>" size="56">
                    </td>
                </tr>
            </table>
        </div>
    ...
    <div class="panel panel-primary panel-default content-panel">
        <div class="panel-body">
            <table class="form-table">
                <tr>
                    <th scope="row"><?php _e( 'Forcefully Redirect', WEBLIZAR_ACL_PRO ) ?></th>
                    <td></td>
                </tr>
                <tr class="radio-span" style="border-bottom:none;">
                    <td>
                        <select id="login_redirect_force" class="standard-dropdown" name="login_redirect_force">
                            <option value="yes"><?php _e( 'Yes', WEBLIZAR_ACL_PRO ) ?> </option>
                            <option value="no"><?php _e( 'No', WEBLIZAR_ACL_PRO ) ?> </option>

                        </select>
                       
                        <script type="text/javascript">
                           var acl_lrf = '<?php echo "$login_redirect_force"; ?>';
                           jQuery('#login_redirect_force').find('option[value="' + acl_lrf + '"]').attr('selected', 'selected')
                       </script>
                    </td>
                </tr>
                <tr class="radio-span" style="border-bottom:none;">
                    <td>
                        <input type="text" class="login_force_redirect_url" id="login_force_redirect_url"
                               name="login_force_redirect_url"
                               placeholder="<?php _e( 'Redirect Force URL', WEBLIZAR_ACL_PRO ) ?>" size="56"
                               value="<?php echo $login_force_redirect_url; ?>"><br>
                        <span style="color:#ef4238"><?php _e( 'Enter the URL to user forcefully redirect to admin panel or another when if hit the site url.', WEBLIZAR_ACL_PRO ) ?></span>
                    </td>
                </tr>
            </table>
        </div>
    ...
    <div class="panel panel-primary panel-default content-panel">
        <div class="panel-body">
            <table class="form-table">
                <tr>
                    <th scope="row"><?php _e( 'Redirect Users After Login (Not Work For Admin)', WEBLIZAR_ACL_PRO ) ?></th>
                    <td></td>
                </tr>
                <tr class="radio-span" style="border-bottom:none;">
                    <td>
                        <input type="text" class="login_redirect_user" id="login_redirect_user"
                               name="login_redirect_user" placeholder="<?php _e( 'Redirect URL', WEBLIZAR_ACL_PRO ) ?>"
                               size="56" value="<?php echo $login_redirect_user; ?>"><br>
                        <span style="color:#ef4238"><?php _e( 'Enter the URL to redirect users after login, Setting will not work for an administrator.', WEBLIZAR_ACL_PRO ) ?></span>
                    </td>
                </tr>
            </table>
        </div>
    ...
    <div class="panel panel-primary panel-default content-panel">
        <div class="panel-body">
            <table class="form-table">
                <tr>
                    <th scope="row"><?php _e( 'Display Note To User Above Login Form', WEBLIZAR_ACL_PRO ); ?></th>
                    <td></td>
                </tr>
                <tr style="border-bottom:none;">
                    <td>
                        <textarea type="text" class="pro_text" placeholder="Enter Message" id="log_form_above_msg"
                                  name="log_form_above_msg"><?php echo $log_form_above_msg; ?></textarea>
                    </td>
                </tr>
            </table>
        </div>
    ...
    <div class="panel panel-primary panel-default content-panel">
        <div class="panel-body">
            <table class="form-table">
                <tr>
                    <th scope="row"><?php _e( 'Custom Error Message On Wrong Username & Password', WEBLIZAR_ACL_PRO ); ?></th>
                    <td></td>
                </tr>
                <tr style="border-bottom:none;">
                    <td>
                        <textarea type="text" class="pro_text" placeholder="Enter Message" id="custom_error_msg"
                                  name="custom_error_msg"><?php echo $custom_error_msg; ?></textarea>
                    </td>
                </tr>
            </table>
        </div>
    ...
    <div class="panel panel-primary panel-default content-panel">
        <div class="panel-body">
            <table class="form-table">
                <tr>
                    <th scope="row"><?php _e( 'Message Font Size', WEBLIZAR_ACL_PRO ) ?></th>
                    <td></td>
                </tr>
                <tr style="border-bottom:none;">
                    <td>
                        <div id="button-msg-font-resizer" class="size-slider"
                             style="width: 30%;display:inline-block"></div>
                        <input type="text" class="slider-text" id="login-msg-text-size" name="login-msg-text-size"
                               readonly="readonly">
                        <span class="slider-text-span">Px</span>
                    </td>
                </tr>
    ...
    <div class="panel panel-primary panel-default content-panel">
        <div class="panel-body">
            <table class="form-table">
                <tr>
                    <th scope="row"><?php _e( 'Message Font Color', WEBLIZAR_ACL_PRO ) ?></th>
                    <td></td>
                </tr>
                <tr style="border-bottom:none;">
                    <td id="td-login-msg-font-color">
                        <input id="login-msg-font-color" name="login-msg-font-color" type="text"
                               value="<?php echo $login_msg_font_color; ?>" class="my-color-field"
    ...
    <div class="panel panel-primary panel-default content-panel">
        <div class="panel-body">
            <table class="form-table">
                <tr>
                    <th scope="row"><?php _e( 'Tagline Message Display Below Login Form', WEBLIZAR_ACL_PRO ); ?></th>
                    <td></td>
                </tr>
                <tr style="border-bottom:none;">
                    <td>
                        <textarea type="text" rows="4" class="pro_text" placeholder="Enter Tagline Message"
                                  id="tagline_msg"
                                  name="tagline_msg"><?php $edit_tagline_msg = stripslashes( $tagline_msg );
							echo $edit_tagline_msg; ?></textarea>
                        <p>
                            <i>Please type your message continuously, don't use Enter.</i>
                        </p>
                    </td>
                </tr>
            </table>
    ...
    <div class="panel panel-primary panel-default content-panel">
        <div class="panel-body">
            <table class="form-table">
                <tr>
                    <th scope="row" ><?php _e('Tagline Text Color', WEBLIZAR_ACL_PRO)?></th>
                    <td></td>
                </tr>
                <tr style="border-bottom:none;">
                    <td id="td-login-tagline-text-color">
                        <input id="login-tagline-text-color" name="login-tagline-text-color" type="text" value="<?php echo $login_tagline_text_color; ?>" class="my-color-field" data-default-color="#ffffff"/>
                    </td>
                </tr>
            </table>
        </div>
    ...
    <div class="panel panel-primary panel-default content-panel">
        <div class="panel-body">
            <table class="form-table">
                <tr>
                    <th scope="row" ><?php _e('Tagline Link Color', WEBLIZAR_ACL_PRO)?></th>
                    <td></td>
                </tr>
                <tr style="border-bottom:none;">
                    <td id="td-login-tagline-link-color">
                        <input id="login-tagline-link-color" name="login-tagline-link-color" type="text" value="<?php echo $login_tagline_link_color; ?>" class="my-color-field" data-default-color="#f00"/>
                    </td>
                </tr>
            </table>
        </div>
    ...
    <div class="panel panel-primary panel-default content-panel">
        <div class="panel-body">
            <table class="form-table">
                <tr>
                    <th scope="row"><?php _e( 'Custom CSS', WEBLIZAR_ACL_PRO ) ?></th>
                    <td></td>
                </tr>
                <tr class="radio-span" style="border-bottom:none;">
                    <td>
                        <textarea id="login_custom_css" name="login_custom_css"
                                  placeholder="<?php _e( 'Custom CSS', WEBLIZAR_ACL_PRO ) ?>" type="text"
                                  class="login_custom_css" rows="10" cols="75"
                                  style="width:80%"><?php echo $login_custom_css; ?></textarea>
                        <p class="description">
							<?php _e( 'Enter any custom css you want to apply on login panel.', WEBLIZAR_ACL_PRO ); ?>
                            .<br>
							<?php _e( 'Note: Please Do Not Use', WEBLIZAR_ACL_PRO ); ?>
                            <b>Style</b> <?php _e( 'Tag With Custom CSS', WEBLIZAR_ACL_PRO ); ?>.
                        </p>
                    </td>
                </tr>
            </table>
    ...
    <div id="somedialog2" class="dialog" style="position: fixed; z-index: 9999;">
        ...
        <div class="dialog__content">
            ...
            <div class="dialog-inner">
                <h2>
                    <strong><?php _e( 'Login', WEBLIZAR_ACL_PRO ) ?></strong> <?php _e( 'Setting Save Successfully', WEBLIZAR_ACL_PRO ) ?>
                </h2>
                <div>
                    <button class="action dialog-button-close" data-dialog-close
                            id="dialog-close-button2"><?php _e( 'Close', WEBLIZAR_ACL_PRO ) ?></button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="somedialog8" class="dialog" style="position: fixed; z-index: 9999;">
        ...
        <div class="dialog__content">
            ...
            <div class="dialog-inner">
                <h2>
                    <strong><?php _e( 'Login', WEBLIZAR_ACL_PRO ) ?></strong> <?php _e( 'Setting Reset Successfully', WEBLIZAR_ACL_PRO ) ?>
                </h2>
                <div>
                    <button class="action dialog-button-close" data-dialog-close
                            id="dialog-close-button8"><?php _e( 'Close', WEBLIZAR_ACL_PRO ) ?></button>
                </div>
            </div>
        </div>
    </div>
    <div class="panel panel-primary save-button-block">
        <div class="panel-body">
            <div class="pull-left">
                <button type="button" onclick="return Custom_login_login('loginbgSave', '');"
                        class="btn btn-info btn-lg"><?php _e( 'Save Changes', WEBLIZAR_ACL_PRO ) ?></button>
            </div>
            <div class="pull-right">
                <button type="button" onclick="return Custom_login_login('loginbgReset', '');"
...
<script>
    function Custom_login_login(Action, id) {
        if (Action == "loginbgSave") {
            ...
            var PostData = "Action=" + Action + "&login_form_position=" + login_form_position + "&Login_bg_value=" + Login_bg_value + "&login_background_color=" + login_background_color + "&login_bg_color_overlay=" + login_bg_color_overlay + "&login_bg_image=" + login_bg_image + "&login_form_opacity=" + login_form_opacity + "&login_form_width=" + login_form_width + "&login_form_radius=" + login_form_radius + "&login_border_style=" + login_border_style + "&login_border_thikness=" + login_border_thikness + "&login_border_color=" + login_border_color + "&login_bg_repeat=" + login_bg_repeat + "&login_bg_position=" + login_bg_position + "&login_enable_shadow=" + login_enable_shadow + "&login_shadow_color=" + login_shadow_color + "&login_custom_css=" + login_custom_css + "&login_redirect_user=" + login_redirect_user + "&login_redirect_force=" + login_redirect_force + "&login_force_redirect_url=" + login_force_redirect_url + "&login_form_left=" + login_form_left + "&log_form_above_msg=" + log_form_above_msg + "&login_msg_font_color=" + login_msg_font_color + "&login_tagline_text_color=" + login_tagline_text_color + "&login_tagline_link_color=" + login_tagline_link_color + "&login_msg_fontsize=" + login_msg_fontsize + "&login_form_top=" + login_form_top + "&login_form_float=" + login_form_float + "&tagline_msg=" + tagline_msg + "&custom_error_msg=" + custom_error_msg + "&user_cust_lbl=" + user_cust_lbl + "&pass_cust_lbl=" + pass_cust_lbl + '&label_username=' + label_username + '&label_password=' + label_password + '&label_loginButton=' + label_loginButton;
            jQuery.ajax({
                dataType: 'html',
                type: 'POST',
                url: location.href,
        ...
        if (Action == "loginbgReset") {
            ...
            jQuery.ajax({
                ...
                success: function (data) {
                    ...
                    //Login Image
                    document.getElementById("login_bg_image").value = "<?php echo WEBLIZAR_ACL_PLUGIN_URL_PRO?>/images/3d-background.jpg";
...
if ( isset( $_POST['Action'] ) ) {
	...
	if ( $Action == "loginbgSave" ) {
		...
		$custom_error_msg         = sanitize_option( 'custom_error_msg', $_POST['custom_error_msg'] );
