...
<div class="row">
                    ...
                    <div class="post-social post-social-xs" id="post-social-5">
                        <div class="text-center padding-all text-center">
                            <div class="textbox text-white   margin-bottom settings-title">
                                <?php _e('Google Captcha Settings',WEBLIZAR_ACL_PRO)?>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="panel panel-primary panel-default content-panel">
        <div class="panel-body">
            <table class="form-table">
                <tr>
                    <th scope="row" ><?php _e('Captcha Display',WEBLIZAR_ACL_PRO)?></th>
                    <td></td>
                </tr>
                <tr class="radio-span">
                    <td>
                        <span>
                            <input type="radio" name="enable_gacptcha" value="yes" id="login_enable_gcaptcha1" <?php if($login_enable_gcaptcha=="yes")echo "checked"; ?> />&nbsp;<?php _e('Enable', WEBLIZAR_ACL_PRO)?><br>
                        </span>
                        <span>
                            <input type="radio" name="enable_gacptcha" value="no" id="login_enable_gcaptcha2" <?php if($login_enable_gcaptcha=="no")echo "checked"; ?> />&nbsp;<?php _e('Disable', WEBLIZAR_ACL_PRO)?><br>
                        </span>
                ...
                <tr>
                    <th scope="row" ><?php _e('Google Captcha v2 and v3 Settings',WEBLIZAR_ACL_PRO)?></th>
                    <td></td>
                </tr>
                <tr class="radio-span">
                    <td>
                ...
                <tr>
                    <th scope="row" ><?php _e('Choose Google Captcha Version',WEBLIZAR_ACL_PRO)?></th>
                    <td></td>
                </tr>
                <tr class="radio-span">
                    <td>
                        <span>
                            <input type="radio" name="v_gacptcha" value="v2" id="login_v_gcaptcha1" <?php if($login_v_gcaptcha=="v2")echo "checked"; ?> />&nbsp;<?php _e('v2', WEBLIZAR_ACL_PRO)?><br>
                        </span>
                        <span>
                            <input type="radio" name="v_gacptcha" value="v3" id="login_v_gcaptcha2" <?php if($login_v_gcaptcha=="v3")echo "checked"; ?> />&nbsp;<?php _e('v3', WEBLIZAR_ACL_PRO)?><br>
                        </span>
                ...
                <tr class="recaptcha_keys_v2">
                    <th scope="row" ><?php _e('Site Key',WEBLIZAR_ACL_PRO)?></th>
                    <td></td>
                </tr>
                <tr class="radio-span recaptcha_keys_v2">
                    <td>
                        <input type="text" class="pro_text" id="site-key" name="site-key" placeholder="<?php _e('Site Key',WEBLIZAR_ACL_PRO)?>" size="56" value="<?php echo $site_key; ?>"/>
                    </td>
                </tr>
                <tr class="recaptcha_keys_v2">
                    <th scope="row" ><?php _e('Secret Key',WEBLIZAR_ACL_PRO)?></th>
                    <td></td>
                </tr>
                <tr class="radio-span recaptcha_keys_v2">
                    <td>
                        <input type="text" class="pro_text" id="secret-key" name="secret-key" placeholder="<?php _e('Secret Key',WEBLIZAR_ACL_PRO)?>" size="56" value="<?php echo $secret_key; ?>"/>
                    </td>
                </tr>
                <tr class="recaptcha_keys_v2">
                    <th scope="row" ><?php _e('Captcha Theme',WEBLIZAR_ACL_PRO)?></th>
                    <td></td>
                </tr>
                <tr class="radio-span recaptcha_keys_v2">
                    <td>
                        <span>
                            <input type="radio" name="acl_gcaptcha_theme" value="yes" id="acl_gcaptcha_theme1" <?php if($acl_gcaptcha_theme=="yes")echo "checked"; ?> />&nbsp;<?php _e('Light', WEBLIZAR_ACL_PRO)?><br>
                        </span>
                        <span>
                            <input type="radio" name="acl_gcaptcha_theme" value="no" id="acl_gcaptcha_theme2" <?php if($acl_gcaptcha_theme=="no")echo "checked"; ?> />&nbsp;<?php _e('Dark', WEBLIZAR_ACL_PRO)?><br>
                        </span>
                    </td>
                </tr> 
                ...
                <tr class="radio-span recaptcha_keys_v3">
                    <td>
                        <input type="text" class="pro_text" id="site-key-v3" name="site-key-v3" placeholder="<?php _e('Site Key',WEBLIZAR_ACL_PRO)?>" size="56" value="<?php echo $site_key_v3; ?>"/>
                    </td>
                </tr>
                <tr class="recaptcha_keys_v3">
                    <th scope="row" ><?php _e('Secret Key',WEBLIZAR_ACL_PRO)?></th>
                ...
                <tr class="radio-span recaptcha_keys_v3">
                    <td>
                        <input type="text" class="pro_text" id="secret-key-v3" name="secret-key-v3" placeholder="<?php _e('Secret Key',WEBLIZAR_ACL_PRO)?>" size="56" value="<?php echo $secret_key_v3; ?>"/>
                    </td>
                </tr>
    ...
    <div id="somedialog49" class="dialog">
        ...
        <div class="dialog__content">
            ...
            <div class="dialog-inner">
                <h2><strong><?php _e('Google Captcha',WEBLIZAR_ACL_PRO)?></strong> <?php _e('Setting Save Successfully',WEBLIZAR_ACL_PRO)?></h2><div><button class="action dialog-button-close" data-dialog-close id="dialog-close-button49"><?php _e('Close',WEBLIZAR_ACL_PRO)?></button></div>
            </div>
        </div>
    </div>
    ...
    <div id="somedialog109" class="dialog">
        ...
        <div class="dialog__content">
            ...
            <div class="dialog-inner">
                <h2><strong><?php _e('Google Captcha',WEBLIZAR_ACL_PRO)?></strong> <?php _e('Setting Reset Successfully',WEBLIZAR_ACL_PRO)?></h2><div><button class="action dialog-button-close" data-dialog-close id="dialog-close-button109"><?php _e('Close',WEBLIZAR_ACL_PRO)?></button></div>
            </div>
        </div>
    </div>
    <div class="panel panel-primary save-button-block">
        <div class="panel-body">
            <div class="pull-left">
                <button type="button" onclick="return Custom_gcaptcha('googleSave', '');" class="btn btn-info btn-lg"><?php _e('Save Changes',WEBLIZAR_ACL_PRO)?></button>
            </div>
            <div class="pull-right">
                <button type="button" onclick="return Custom_gcaptcha('googleReset', '');" class="btn btn-primary btn-lg"><?php _e('Reset Default',WEBLIZAR_ACL_PRO)?></button>
            </div>
        </div>
    </div>
</div>
