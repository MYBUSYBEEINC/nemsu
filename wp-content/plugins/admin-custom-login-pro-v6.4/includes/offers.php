                    ...
                    <div class="post-social post-social-xs" id="post-social-5">
                        <div class="text-center padding-all text-center">
                            <div class="textbox text-white   margin-bottom settings-title">
								<?php _e( 'Our Offers', WEBLIZAR_ACL_PRO ) ?>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="tab-content">
            <div id="themesd" class="tab-pane fade in active">
                <div class="space  theme active">
                    ...
                    <div class="row p_plugin blog_gallery">
                        <div class="col-xs-12 col-sm-4 col-md-5 p_plugin_pic">
                            <div class="img-thumbnail">
                                <img src="<?php echo WEBLIZAR_ACL_PLUGIN_URL_PRO . '/images/BeautySpa.jpg'; ?>"
                        ...
                        <div class="col-xs-12 col-sm-5 col-md-5 p_plugin_desc">
                            <div class="row p-box">
                                ...
                                <p><strong>Tags: </strong>Customize Front Page, Multilingual, Complete Documentation,
                                    Theme Option Panel, Unlimited Color Skins, Multiple Background Patterns, Multiple
                                    Theme Templates, 5 Portfolio Layout, 3 Page Layout and many more.</p>
                                <div>
                                    <p><strong>Description: </strong> BeautySpa is versatile health care business
                                        WordPress theme suitable for spa, spa salon, sauna, massage , medical business,
                                        massage center, beauty center, eCommerce and beauty salon websites.</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row p_plugin blog_gallery">
                        <div class="col-xs-12 col-sm-4 col-md-5 p_plugin_pic">
                            <div class="img-thumbnail">
                                <img src="<?php echo WEBLIZAR_ACL_PLUGIN_URL_PRO . '/images/personal.jpg'; ?>"
                                     class="img-responsive" alt="img"/>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-5 col-md-5 p_plugin_desc">
                            <div class="row p-box">
                                ...
                                <div>
                                    <p><strong>Description: </strong> Personal Premium is a powerful and flexible,
                                        customizable and extensively developed, wonderfully lightweight and mobile
                                        friendly, easy to use and intuitively structured. Personal Premium is a highly
                                        customizable and SEO friendly responsive WordPress theme you have access to
                                        unlimited color variations, multiple different layout options, shortcode
                                        modules, and much more.</div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-3 col-md-2 p_plugin_pic">
                            <div class="price">
                    ...
                    <div class="row p_plugin blog_gallery">
                        <div class="col-xs-12 col-sm-4 col-md-5 p_plugin_pic">
                            <div class="img-thumbnail">
                                <img src="<?php echo WEBLIZAR_ACL_PLUGIN_URL_PRO . '/images/explora.jpg'; ?>"
                                     class="img-responsive" alt="img"/>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-5 col-md-5 p_plugin_desc">
                            <div class="row p-box">
                                ...
                                <div>
                                    <p><strong>Description: </strong> Explora Premium is a multi-purpose responsive
                                        theme coded & designed with a lot of care and love. You can use it for your
                                        business, portfolio, blogging or any type of site.</div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-3 col-md-2 p_plugin_pic">
                            <div class="price">
                            ...
                            <div class="btn-group-vertical">
                                ...
                                <a class="btn btn-success btn-lg" href="https://weblizar.com/explora-premium/">Buy
                                    Now</a>
                            </div>
                        </div>
                    </div>
                    <div class="row p_plugin blog_gallery">
                        <div class="col-xs-12 col-sm-4 col-md-5 p_plugin_pic">
                            <div class="img-thumbnail">
                                <img src="<?php echo WEBLIZAR_ACL_PLUGIN_URL_PRO . '/images/Guardian.jpg'; ?>"
                                     class="img-responsive" alt="img"/>
                            ...
                            <div class="row p-box">
                                ...
                                <div>
                                    <p><strong>Description: </strong> Guardian Premium Theme is a super professional one
                                        page WordPress theme for modern businesses. Ideal for creative agencies,
                                        startups, small businesses, and freelancers and best of all it is so easy to use
                                        that you can have your website up in minutes.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-3 col-md-2 p_plugin_pic">
                    ...
                    <div class="row p_plugin blog_gallery">
                        <div class="col-xs-12 col-sm-4 col-md-5 p_plugin_pic">
                            <div class="img-thumbnail">
                                <img src="<?php echo WEBLIZAR_ACL_PLUGIN_URL_PRO . '/images/Enigma.jpg'; ?>"
                                     class="img-responsive" alt="img"/>
                            ...
                            <div class="row p-box">
                                ...
                                <div>
                                    <p><strong>Description: </strong> Enigma is a Full Responsive Multi-Purpose Theme
                                        suitable for Business , corporate office and others .Cool Blog Layout and full
                                        width page also present.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-3 col-md-2 p_plugin_pic">
            ...
            <div id="pluginsd" class="tab-pane fade">
                ...
                <div class="row p_plugin blog_gallery">
                    <div class="col-xs-12 col-sm-4 col-md-5 p_plugin_pic">
                        <div class="img-thumbnail">
                            <img src="<?php echo WEBLIZAR_ACL_PLUGIN_URL_PRO . '/images/Clockin-Pro.jpg'; ?>"
                                 class="img-responsive" alt="img"/>
                ...
                <div class="row p_plugin blog_gallery">
                    <div class="col-xs-12 col-sm-4 col-md-5 p_plugin_pic">
                        <div class="img-thumbnail">
                            <div class="img-thumbnail">
                                <img src="<?php echo WEBLIZAR_ACL_PLUGIN_URL_PRO . '/images/facebook-feed.jpg'; ?>"
                                     class="img-responsive" alt="img"/>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row p_plugin blog_gallery">
                    <div class="col-xs-12 col-sm-4 col-md-5 p_plugin_pic">
                        <div class="img-thumbnail">
                            <img src="<?php echo WEBLIZAR_ACL_PLUGIN_URL_PRO . '/images/Pinterest-Feed.jpg'; ?>"
                                 class="img-responsive" alt="img"/>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-5 col-md-5 p_plugin_desc">
                ...
                <div class="row p_plugin blog_gallery">
                    <div class="col-xs-12 col-sm-4 col-md-5 p_plugin_pic">
                        <div class="img-thumbnail">
                            <img src="<?php echo WEBLIZAR_ACL_PLUGIN_URL_PRO . '/images/Search-Engine-Optimizer-new.jpg'; ?>"
                                 class="img-responsive" alt="img"/>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-5 col-md-5 p_plugin_desc">
                ...
                <div class="row p_plugin blog_gallery">
                    <div class="col-xs-12 col-sm-4 col-md-5 p_plugin_pic">
                        <div class="img-thumbnail">
                            <img src="<?php echo WEBLIZAR_ACL_PLUGIN_URL_PRO . '/images/newsletter.png'; ?>"
                                 class="img-responsive" alt="img"/>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-5 col-md-5 p_plugin_desc">
                    ...
                    <div class="col-xs-12 col-sm-3 col-md-2 p_plugin_pic">
                        ...
                        <div class="btn-group-vertical">
                            ...
                            <a class="btn btn-success btn-lg"
                               href="https://weblizar.com/newsletter-subscription-form-pro/">Buy Now</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="row p_plugin blog_gallery">
                    <div class="col-xs-12 col-sm-4 col-md-5 p_plugin_pic">
                        <div class="img-thumbnail">
                            <img src="<?php echo WEBLIZAR_ACL_PLUGIN_URL_PRO . '/images/Comingsoon.jpg'; ?>"
                                 class="img-responsive" alt="img"/>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-5 col-md-5 p_plugin_desc">
                ...
                <div class="row p_plugin blog_gallery">
                    <div class="col-xs-12 col-sm-4 col-md-5 p_plugin_pic">
                        <div class="img-thumbnail">
                            <img src="<?php echo WEBLIZAR_ACL_PLUGIN_URL_PRO . '/images/responsive-pro.jpg'; ?>"
                                 class="img-responsive" alt="img"/>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-5 col-md-5 p_plugin_desc">
                    ...
                    <div class="col-xs-12 col-sm-3 col-md-2 p_plugin_pic">
                        ...
                        <div class="btn-group-vertical">
                            <a class="btn btn-primary btn-lg"
                               href="https://weblizar.com/plugins/responsive-portfolio-pro/">Demo</a>
                            <a class="btn btn-success btn-lg"
                               href="https://weblizar.com/plugins/responsive-portfolio-pro/">Buy Now</a>
                        </div>
                    </div>
                </div>
            ...
            <div id="offers" class="tab-pane fade">
                <div class="space  theme active">
                    ...
                    <div class="row p_plugin blog_gallery">
                        <div class="col-xs-12 col-sm-4 col-md-5 p_plugin_pic">
                            <div class="img-thumbnail">
                                <img src="<?php echo WEBLIZAR_ACL_PLUGIN_URL_PRO . '/images/offer.jpg'; ?>"
                                     class="img-responsive" alt="img"/>
