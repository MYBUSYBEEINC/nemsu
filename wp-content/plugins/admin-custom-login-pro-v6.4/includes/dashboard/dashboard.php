...
<div class="row">
                    ...
                    <div class="post-social post-social-xs" id="post-social-5">
                        <div class="text-center padding-all text-center">
                            <div class="textbox text-white   margin-bottom settings-title">
								<?php _e( 'Admin Custom Login Dashboard', WEBLIZAR_ACL_PRO ); ?>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="panel panel-primary panel-default content-panel">
        <div class="panel-body">
            <table class="form-table">
                <tr>
                    <th scope="row"><?php _e( 'Admin Custom Login Status', WEBLIZAR_ACL_PRO ) ?></th>
                    <td></td>
                </tr>
                <tr class="radio-span" style="border-bottom:none;">
                    <td>
						<span>
							<input type="radio" name="dashboard_status" value="disable"
                                   id="dashboard_status1" <?php if ( $dashboard_status == "disable" ) {
								echo "checked";
							} ?> />&nbsp;<?php _e( 'Disable', WEBLIZAR_ACL_PRO ) ?><br>
						</span>
                        <span>
							<input type="radio" name="dashboard_status" value="enable"
                                   id="dashboard_status2" <?php if ( $dashboard_status == "enable" ) {
								echo "checked";
    ...
    <div class="panel panel-primary panel-default content-panel">
        <div class="panel-body">
            <table class="form-table">
                <tr>
                    <th scope="row"><?php _e( 'View Login Page', WEBLIZAR_ACL_PRO ) ?></th>
                    <td></td>
                </tr>
                <tr class="radio-span" style="border-bottom:none;">
                    <td>
                        <h4><?php _e( 'Copy below link and open in another browser where you are not logged in', WEBLIZAR_ACL_PRO ) ?></h4>
                        <br>
    ...
    <!-- <div class="panel panel-primary panel-default content-panel">
		<div class="panel-body">
			<table class="form-table">
				<tr>
					<th scope="row" ><?php _e( 'Donate Us', WEBLIZAR_ACL_PRO ) ?></th>
					<td></td>
				</tr>
				<tr class="radio-span" style="border-bottom:none;">
					<td class="colcent">
    ...
    <div id="somedialog" class="dialog" style="position: fixed; z-index: 9999;">
        ...
        <div class="dialog__content">
            ...
            <div class="dialog-inner">
                <h2>
                    <strong><?php _e( 'Dashboard', WEBLIZAR_ACL_PRO ); ?></strong> <?php _e( 'Setting Save Successfully', WEBLIZAR_ACL_PRO ); ?>
                </h2>
                <div>
                    <button class="action dialog-button-close" data-dialog-close
                            id="dialog-close-button"><?php _e( 'Close', WEBLIZAR_ACL_PRO ); ?></button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="somedialog7" class="dialog" style="position: fixed; z-index: 9999;">
        ...
        <div class="dialog__content">
            ...
            <div class="dialog-inner">
                <h2>
                    <strong><?php _e( 'Dashboard', WEBLIZAR_ACL_PRO ) ?></strong> <?php _e( 'Setting Reset Successfully', WEBLIZAR_ACL_PRO ) ?>
                </h2>
                <div>
                    <button class="action dialog-button-close" data-dialog-close
                            id="dialog-close-button7"><?php _e( 'Close', WEBLIZAR_ACL_PRO ) ?></button>
                </div>
            </div>
        </div>
    </div>
    <div class="panel panel-primary save-button-block">
        <div class="panel-body">
            <div class="pull-left">
                <button type="button" onclick="return Custom_login_dashboard('dashboardSave', '');"
                        class="btn btn-info btn-lg"><?php _e( 'Save Changes', WEBLIZAR_ACL_PRO ); ?></button>
            </div>
            <div class="pull-right">
                <button type="button" onclick="return Custom_login_dashboard('dashboardReset', '');"
