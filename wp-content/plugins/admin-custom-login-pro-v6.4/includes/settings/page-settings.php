...
<Script>
    ...
    jQuery(function () {
        ...
        jQuery("#logo-width-slider").slider("value",<?php if ( $logo_width != "" ) {
			echo $logo_width;
		} else {
			echo "200";
		}?>);
    ...
    jQuery(function () {
        ...
        jQuery("#logo-height-slider").slider("value",<?php if ( $logo_height != "" ) {
			echo $logo_height;
		} else {
			echo "60";
		}?> );
...
<div class="row">
                    ...
                    <div class="post-social post-social-xs" id="post-social-5">
                        <div class="text-center padding-all text-center">
                            <div class="textbox text-white   margin-bottom settings-title">
								<?php _e( 'Logo Settings', WEBLIZAR_ACL_PRO ) ?>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="panel panel-primary panel-default content-panel">
        <div class="panel-body">
            <table class="form-table">
                <tr>
                    <th scope="row"><?php _e( 'Logo Image', WEBLIZAR_ACL_PRO ) ?></th>
                    <td></td>
                </tr>
                <tr class="radio-span" style="border-bottom:none;">
                    <td>
                        <input type="text" class="pro_text" id="logo-image"
                               placeholder="<?php _e( 'No media selected!', WEBLIZAR_ACL_PRO ) ?>" name="upload_image"
                               disabled="disabled" value="<?php echo $logo_image; ?>"/>
                        <input type="button" value="<?php _e( 'Upload', WEBLIZAR_ACL_PRO ) ?>" id="upload-logo"
                               class="button-primary rcsp_media_upload"/>

                        <input type="button" id="display-logo" value="<?php _e( 'Preview', WEBLIZAR_ACL_PRO ) ?>"
                               data-toggle="modal" data-target="#logo_about_us_image_builder" class="button "
                               onclick="Acl_show_Image_3()"/>

                        <!-- Modal -->
                        <div class="modal " id="logo_about_us_image_builder" tabindex="-1" role="dialog"
    ...
    <div class="panel panel-primary panel-default content-panel">
        <div class="panel-body">
            <table class="form-table">
                <tr>
                    <th scope="row" ><?php _e('Show Logo',WEBLIZAR_ACL_PRO)?></th>
                    <td></td>
                </tr>
                <tr class="radio-span" style="border-bottom:none;">
                    <td>
                        <span>
                            <input <?php checked( $logo_show, 'yes', true ); ?> type="radio" name="show_logo" value="yes" id="logo_show1">&nbsp;<?php _e('Yes', WEBLIZAR_ACL_PRO)?><br>
                        </span>
                        <span>
                            <input <?php checked( $logo_show, 'no', true ); ?>  type="radio" name="show_logo" value="no" id="logo_show2">&nbsp;<?php _e('No', WEBLIZAR_ACL_PRO)?><br>
                        </span>
                    </td>
                </tr>
            </table>
    ...
    <div class="panel panel-primary panel-default content-panel">
        <div class="panel-body">
            <table class="form-table">
                <tr>
                    <th scope="row"><?php _e( 'Logo Image Width', WEBLIZAR_ACL_PRO ) ?></th>
                    <td></td>
                </tr>
                <tr style="border-bottom:none;">
                    <td>
                        <div id="logo-width-slider" class="size-slider" style="width: 25%;display:inline-block"></div>
                        <input type="text" class="slider-text" id="logo-width-text-box" name="headline-size-text-box"
                               readonly="readonly">
    ...
    <div class="panel panel-primary panel-default content-panel">
        <div class="panel-body">
            <table class="form-table">
                <tr>
                    <th scope="row"><?php _e( 'Logo Image Height', WEBLIZAR_ACL_PRO ) ?></th>
                    <td></td>
                </tr>
                <tr style="border-bottom:none;">
                    <td>
                        <div id="logo-height-slider" class="size-slider" style="width: 25%;display:inline-block"></div>
                        <input type="text" class="slider-text" id="logo-height-text-box" name="input-size-text-box"
                               readonly="readonly">
                        <span class="slider-text-span">Px</span>
                    </td>
                </tr>
    ...
    <div class="panel panel-primary panel-default content-panel">
        <div class="panel-body">
            <table class="form-table">
                <tr>
                    <th scope="row"><?php _e( 'Logo Link URL', WEBLIZAR_ACL_PRO ) ?></th>
                    <td></td>
                </tr>
                <tr class="radio-span" style="border-bottom:none;">
                    <td>
                        <input type="text" class="pro_text" id="log-url" name="log-url"
                               placeholder="<?php _e( 'Logo URL', WEBLIZAR_ACL_PRO ) ?>" size="56"
    ...
    <div class="panel panel-primary panel-default content-panel">
        <div class="panel-body">
            <table class="form-table">
                <tr>
                    <th scope="row"><?php _e( 'Logo Image Title', WEBLIZAR_ACL_PRO ) ?></th>
                    <td></td>
                </tr>
                <tr class="radio-span" style="border-bottom:none;">
                    <td>
                        <input type="text" class="pro_text" id="log-url-title" name="log-url-title"
                               placeholder="<?php _e( 'Logo URL Title', WEBLIZAR_ACL_PRO ) ?>" size="56"
                               value="<?php echo $logo_url_title; ?>"/>
                    </td>
                </tr>
            </table>
        </div>
    ...
    <div id="somedialog4" class="dialog" style="position: fixed; z-index: 9999;">
        ...
        <div class="dialog__content">
            ...
            <div class="dialog-inner">
                <h2>
                    <strong><?php _e( 'Logo', WEBLIZAR_ACL_PRO ) ?></strong> <?php _e( 'Setting Save Successfully', WEBLIZAR_ACL_PRO ) ?>
                </h2>
                <div>
                    <button class="action dialog-button-close" data-dialog-close
                            id="dialog-close-button4"><?php _e( 'Close', WEBLIZAR_ACL_PRO ) ?></button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="somedialog10" class="dialog" style="position: fixed; z-index: 9999;">
        ...
        <div class="dialog__content">
            ...
            <div class="dialog-inner">
                <h2>
                    <strong><?php _e( 'Logo', WEBLIZAR_ACL_PRO ) ?></strong> <?php _e( 'Setting Reset Successfully', WEBLIZAR_ACL_PRO ) ?>
                </h2>
                <div>
                    <button class="action dialog-button-close" data-dialog-close
                            id="dialog-close-button10"><?php _e( 'Close', WEBLIZAR_ACL_PRO ) ?></button>
                </div>
            </div>
        </div>
    </div>
    <div class="panel panel-primary save-button-block">
        <div class="panel-body">
            <div class="pull-left">
                <button type="button" onclick="return Custom_login_logo('logoSave', '');"
                        class="btn btn-info btn-lg"><?php _e( 'Save Changes', WEBLIZAR_ACL_PRO ) ?></button>
            </div>
            <div class="pull-right">
                <button type="button" onclick="return Custom_login_logo('logoReset', '');"
    ...
    function Custom_login_logo(Action, id) {
        ...
        if (Action == "logoReset") {
            ...
            jQuery.ajax({
                ...
                success: function (data) {
                    document.getElementById("logo-image").value = "<?php echo WEBLIZAR_ACL_PLUGIN_URL_PRO?>/images/default-logo.jpg";
...
if ( isset( $_POST['Action'] ) ) {
	...
	if ( $Action == "logoSave" ) {
		...
		$logo_url_title = stripslashes( html_entity_decode( $_POST['logo_url_title'], ENT_QUOTES, 'UTF-8' ) );
