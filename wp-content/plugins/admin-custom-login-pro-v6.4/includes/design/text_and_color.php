...
<Script>
    ...
    jQuery(function () {
        ...
        jQuery("#button-size-slider").slider("value",<?php if ( $heading_font_size != "" ) {
    ...
    jQuery(function () {
        ...
        jQuery("#button-size-slider2").slider("value",<?php if ( $input_font_size != "" ) {
			echo $input_font_size;
		} else {
			echo "30";
		}?> );
    ...
    jQuery(function () {
        ...
        jQuery("#button-size-slider3").slider("value",<?php if ( $link_size != "" ) {
			echo $link_size;
		} else {
			echo "30";
		}?>);
    ...
    jQuery(function () {
        ...
        jQuery("#button-size-slider7").slider("value",<?php if ( $button_font_size != "" ) {
			echo $button_font_size;
		} else {
			echo "30";
		}?> );
    ...
    jQuery(document).ready(function () {
        //Headline Font Style
        jQuery("#headline_font_style").val('<?php if ( $heading_font_style != "" ) {
			echo $heading_font_style;
		} else {
			echo "";
		}?>');
        //Input Font Style
        jQuery("#input_font_style").val('<?php if ( $input_font_style != "" ) {
			echo $input_font_style;
		} else {
			echo "";
		}?>');
        //Link Font Style
        jQuery("#link_font_style").val('<?php if ( $link_font_style != "" ) {
			echo $link_font_style;
		} else {
			echo "";
		}?>');
        //Button Font Style
        jQuery("#button_font_style").val('<?php if ( $button_font_style != "" ) {
			echo $button_font_style;
		} else {
			echo "";
		}?>');
    });
...
<div class="row">
                    ...
                    <div class="post-social post-social-xs" id="post-social-5">
                        <div class="text-center padding-all text-center">
                            <div class="textbox text-white   margin-bottom settings-title">
								<?php _e( 'Text And Color Settings', WEBLIZAR_ACL_PRO ) ?>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="panel panel-primary panel-default content-panel">
        <div class="panel-body">
            <table class="form-table">
                <tr>
                    <th scope="row"><?php _e( 'Headline Font Color', WEBLIZAR_ACL_PRO ) ?></th>
                    <td></td>
                </tr>
                <tr style="border-bottom:none;">
                    <td id="td-headline-font-color">
                        <input id="headline-font-color" name="headline-font-color" type="text"
                               value="<?php echo $heading_font_color; ?>" class="my-color-field"
    ...
    <div class="panel panel-primary panel-default content-panel">
        <div class="panel-body">
            <table class="form-table">
                <tr>
                    <th scope="row"><?php _e( 'Input Font Color', WEBLIZAR_ACL_PRO ) ?></th>
                    <td></td>
                </tr>
                <tr style="border-bottom:none;">
                    <td id="td-input-font-color">
                        <input id="input-font-color" name="input-font-color" type="text"
                               value="<?php echo $input_font_color; ?>" class="my-color-field"
                               data-default-color="#ffffff"/>
                    </td>
                </tr>
            </table>
    ...
    <div class="panel panel-primary panel-default content-panel">
        <div class="panel-body">
            <table class="form-table">
                <tr>
                    <th scope="row"><?php _e( 'Link Color', WEBLIZAR_ACL_PRO ) ?></th>
                    <td></td>
                </tr>
                <tr style="border-bottom:none;">
                    <td id="td-link-font-color">
                        <input id="link-color" name="link-color" type="text" value="<?php echo $link_color; ?>"
    ...
    <div class="panel panel-primary panel-default content-panel">
        <div class="panel-body">
            <table class="form-table">
                <tr>
                    <th scope="row"><?php _e( 'Button Color', WEBLIZAR_ACL_PRO ) ?></th>
                    <td></td>
                </tr>
                <tr style="border-bottom:none;">
                    <td id="td-button-font-color">
                        <input id="button-color" name="button-color" type="text" value="<?php echo $button_color; ?>"
                               class="my-color-field" data-default-color="#ffffff"/>
                    </td>
                </tr>
            </table>
    ...
    <div class="panel panel-primary panel-default content-panel">
        <div class="panel-body">
            <table class="form-table">
                <tr>
                    <th scope="row"><?php _e( 'Login Button Text Color', WEBLIZAR_ACL_PRO ) ?></th>
                    <td></td>
                </tr>
                <tr style="border-bottom:none;">
                    <td id="td-button-font-color">
                        <input id="button-text-color" name="button-text-color" type="text" value="<?php echo $button_text_color; ?>"
                               class="my-color-field" data-default-color="#ffffff"/>
                    </td>
                </tr>
            </table>
    ...
    <div class="panel panel-primary panel-default content-panel">
        <div class="panel-body">
            <table class="form-table">
                <tr>
                    <th scope="row"><?php _e( 'Headline Font size', WEBLIZAR_ACL_PRO ) ?></th>
                    <td></td>
                </tr>
                <tr style="border-bottom:none;">
                    <td>
                        <div id="button-size-slider" class="size-slider" style="width: 25%;display:inline-block"></div>
                        <input type="text" class="slider-text" id="headline-size-text-box" name="headline-size-text-box"
                               readonly="readonly">
    ...
    <div class="panel panel-primary panel-default content-panel">
        <div class="panel-body">
            <table class="form-table">
                <tr>
                    <th scope="row"><?php _e( 'Input Font Size', WEBLIZAR_ACL_PRO ) ?></th>
                    <td></td>
                </tr>
                <tr style="border-bottom:none;">
                    <td>
                        <div id="button-size-slider2" class="size-slider" style="width: 25%;display:inline-block"></div>
                        <input type="text" class="slider-text" id="input-size-text-box" name="input-size-text-box"
                               readonly="readonly">
                        <span class="slider-text-span">Px</span>
                    </td>
                </tr>
    ...
    <div class="panel panel-primary panel-default content-panel">
        <div class="panel-body">
            <table class="form-table">
                <tr>
                    <th scope="row"><?php _e( 'Link Font Size', WEBLIZAR_ACL_PRO ) ?></th>
                    <td></td>
                </tr>
                <tr style="border-bottom:none;">
                    <td>
                        <div id="button-size-slider3" class="size-slider" style="width: 25%;display:inline-block"></div>
                        <input type="text" class="slider-text" id="link-size-text-box" name="link-size-text-box"
                               readonly="readonly">
                        <span class="slider-text-span">Px</span>
                    </td>
                </tr>
    ...
    <div class="panel panel-primary panel-default content-panel">
        <div class="panel-body">
            <table class="form-table">
                <tr>
                    <th scope="row"><?php _e( 'Button Font Size', WEBLIZAR_ACL_PRO ) ?></th>
                    <td></td>
                </tr>
                <tr style="border-bottom:none;">
                    <td>
                        <div id="button-size-slider7" class="size-slider" style="width: 25%;display:inline-block"></div>
                        <input type="text" class="slider-text" id="button-size-text-box" name="button-size-text-box"
                               readonly="readonly">
                        <span class="slider-text-span">Px</span>
                    </td>
                </tr>
    ...
    <div class="panel panel-primary panel-default content-panel">
        <div class="panel-body">
            <table class="form-table">
                <tr>
                    <th scope="row"><?php _e( 'Enable Link shadow?', WEBLIZAR_ACL_PRO ) ?></th>
                    <td></td>
                </tr>
                <tr class="radio-span" style="border-bottom:none;">
                    <td>
						<span>
							<input type="radio" name="enable_Link_shadow" value="yes"
                                   id="enable_Link_shadow1" <?php if ( $enable_link_shadow == "yes" ) {
								echo "checked";
							} ?> />&nbsp;<?php _e( 'Yes', WEBLIZAR_ACL_PRO ) ?><br>
						</span>
                        <span>
							<input type="radio" name="enable_Link_shadow" value="no"
                                   id="enable_Link_shadow2" <?php if ( $enable_link_shadow == "no" ) {
								echo "checked";
    ...
    <div class="panel panel-primary panel-default content-panel">
        <div class="panel-body">
            <table class="form-table">
                <tr>
                    <th scope="row"><?php _e( 'Link Shadow Color', WEBLIZAR_ACL_PRO ) ?></th>
                    <td></td>
                </tr>
                <tr style="border-bottom:none;">
                    <td>
                        <input id="link-shadow-color" name="link-shadow-color" type="text"
                               value="<?php echo $link_shadow_color; ?>" class="my-color-field"
                               data-default-color="#ffffff"/>
                    </td>
                </tr>
            </table>
    ...
    <div class="panel panel-primary panel-default content-panel">
        <div class="panel-body">
            <table class="form-table">
                <tr>
                    <th scope="row"><?php _e( 'Google Font Token', WEBLIZAR_ACL_PRO ) ?></th>
                    <td></td>
                </tr>
                <tr class="" style="border-bottom:none;">
                    <td>
                        <input type="text" class="form-control" name="google_font_token" id="google_font_token"
                               placeholder="Google Font Token" value="<?php echo $google_font_token; ?>"/>
                    </td>
                </tr>
            </table>
        </div>
    ...
    <div class="panel panel-primary panel-default content-panel">
        <div class="panel-body">
            <table class="form-table">
                <tr>
                    <th scope="row"><?php _e( 'Headline Font Style', WEBLIZAR_ACL_PRO ) ?></th>
                    <td></td>
                </tr>
				<?php $RPP_Font_Style = ""; ?>
                <tr class="" style="border-bottom:none;">
                    <td>
                        <select id="headline_font_style" class="standard-dropdown" name="headline_font_style">
                            <optgroup label="Default Fonts">
                                ...
                                <option value="Arial Black" <?php selected( $RPP_Font_Style, 'Arial Black' ); ?>>Arial
                                    Black
                                </option>
                                <option value="Courier New" <?php selected( $RPP_Font_Style, 'Courier New' ); ?>>Courier
                                    New
                                </option>
                                <option value="Georgia" <?php selected( $RPP_Font_Style, 'Georgia' ); ?>>Georgia
                                </option>
                                <option value="Grande" <?php selected( $RPP_Font_Style, 'Grande' ); ?>>Grande</option>
                                <option value="Helvetica Neue" <?php selected( $RPP_Font_Style, 'Helvetica Neue' ); ?>>
                                    Helvetica Neue
                                </option>
                                ...
                                <option value="Lucida Grande" <?php selected( $RPP_Font_Style, 'Lucida Grande' ); ?>>
                                    Lucida Grande
                                </option>
                                <option value="OpenSansBold" <?php selected( $RPP_Font_Style, 'OpenSansBold' ); ?>>
                                    OpenSansBold
                                </option>
                                <option value="Palatino" <?php selected( $RPP_Font_Style, 'Palatino' ); ?>>Palatino
                                </option>
                                <option value="Sans" <?php selected( $RPP_Font_Style, 'Sans' ); ?>>Sans</option>
                                <option value="Sans-Serif" <?php selected( $RPP_Font_Style, 'Sans-Serif' ); ?>>
                                    Sans-Serif
                                </option>
                                <option value="Tahoma" <?php selected( $RPP_Font_Style, 'Tahoma' ); ?>>Tahoma</option>
                                <option value="Times New Roman"<?php selected( $RPP_Font_Style, 'Times New Roman' ); ?>>
                                    Times New Roman
                                </option>
                                <option value="Trebuchet" <?php selected( $RPP_Font_Style, 'Trebuchet' ); ?>>Trebuchet
                                </option>
                                <option value="Verdana" <?php selected( $RPP_Font_Style, 'Verdana' ); ?>>Verdana
                                </option>
                            </optgroup>
									...
									if ( is_array( $fonts_list ) ) {
										if ( isset( $fonts_list['items'] ) ) {
											...
											foreach ( $g_fonts as $g_font ) {
                                                ...
                                                <option
                                                value="<?php echo $font_name; ?>" <?php selected( $RPP_Font_Style, $font_name ); ?>><?php echo $font_name; ?></option><?php
											}
										}
    ...
    <div class="panel panel-primary panel-default content-panel">
        <div class="panel-body">
            <table class="form-table">
                <tr>
                    <th scope="row"><?php _e( 'Input Font Style', WEBLIZAR_ACL_PRO ) ?></th>
                    <td></td>
                </tr>
				<?php $RPP_Font_Style = ""; ?>
                <tr class="" style="border-bottom:none;">
    ...
    <div class="panel panel-primary panel-default content-panel">
        <div class="panel-body">
            <table class="form-table">
                <tr>
                    <th scope="row"><?php _e( 'Link Font Style', WEBLIZAR_ACL_PRO ) ?></th>
                    <td></td>
                </tr>
				<?php $RPP_Font_Style = ""; ?>
                <tr class="" style="border-bottom:none;">
    ...
    <div class="panel panel-primary panel-default content-panel">
        <div class="panel-body">
            <table class="form-table">
                <tr>
                    <th scope="row"><?php _e( 'Button Font Style', WEBLIZAR_ACL_PRO ) ?></th>
                    <td></td>
                </tr>
				<?php $RPP_Font_Style = ""; ?>
                <tr class="" style="border-bottom:none;">
    ...
    <div class="panel panel-primary panel-default content-panel">
        <div class="panel-body">
            <table class="form-table">
                <tr>
                    <th scope="row"><?php _e( 'Enable Input Box Icon?', WEBLIZAR_ACL_PRO ) ?></th>
                    <td></td>
                </tr>
                <tr class="radio-span" style="border-bottom:none;">
                    <td>
						<span>
							<input type="radio" name="enable_inputbox_icon" value="yes"
                                   id="enable_inputbox_icon1" <?php if ( $enable_inputbox_icon == "yes" ) {
								echo "checked";
							} ?> />&nbsp;<?php _e( 'Yes', WEBLIZAR_ACL_PRO ) ?><br>
						</span>
                        <span>
							<input type="radio" name="enable_inputbox_icon" value="no"
                                   id="enable_inputbox_icon2" <?php if ( $enable_inputbox_icon == "no" ) {
								echo "checked";
							} ?> />&nbsp;<?php _e( 'No', WEBLIZAR_ACL_PRO ) ?><br>
						</span>
                    </td>
    ...
    <div class="panel panel-primary panel-default content-panel">
        <div class="panel-body">
            <table class="form-table">
                <tr>
                    <th scope="row"><?php _e( 'Icon For user Input Box', WEBLIZAR_ACL_PRO ) ?></th>
                    <td></td>
                </tr>
                <tr class="" style="border-bottom:none;">
                    <td>
                        ...
                        <div class="col-md-9">
                            <div class="input-group">
                                <input data-placement="bottomRight" class="form-control icp icp-auto" type="text"
                                       id="user-input-icon" name="user-input-icon"
                                       value="<?php echo $user_input_icon; ?>"/>
    ...
    <div class="panel panel-primary panel-default content-panel">
        <div class="panel-body">
            <table class="form-table">
                <tr>
                    <th scope="row"><?php _e( 'Icon For Password Input Box', WEBLIZAR_ACL_PRO ) ?></th>
                    <td></td>
                </tr>
                <tr class="" style="border-bottom:none;">
                    <td>
                        ...
                        <div class="col-md-9">
                            <div class="input-group">
                                <input data-placement="bottomRight" class="form-control icp icp-auto" type="text"
                                       id="password-input-icon" name="password-input-icon"
                                       value="<?php echo $password_input_icon; ?>"/>
                                <span class="input-group-addon"></span>
                            </div>
                        </div>
                    </td>
    ...
    <div id="somedialog3" class="dialog" style="position: fixed; z-index: 9999;">
        ...
        <div class="dialog__content">
            ...
            <div class="dialog-inner">
                <h2>
                    <strong><?php _e( 'Text and Color', WEBLIZAR_ACL_PRO ); ?></strong> <?php _e( 'Setting Save Successfully', WEBLIZAR_ACL_PRO ) ?>
                </h2>
                <div>
                    <button class="action dialog-button-close" data-dialog-close
                            id="dialog-close-button3"><?php _e( 'Close', WEBLIZAR_ACL_PRO ) ?></button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="somedialog9" class="dialog" style="position: fixed; z-index: 9999;">
        ...
        <div class="dialog__content">
            ...
            <div class="dialog-inner">
                <h2>
                    <strong><?php _e( 'Text and Color', WEBLIZAR_ACL_PRO ) ?></strong> <?php _e( 'Setting Reset Successfully', WEBLIZAR_ACL_PRO ) ?>
                </h2>
                <div>
                    <button class="action dialog-button-close" data-dialog-close
                            id="dialog-close-button9"><?php _e( 'Close', WEBLIZAR_ACL_PRO ) ?></button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="panel panel-primary save-button-block">
        <div class="panel-body">
            <div class="pull-left">
                <button type="button" onclick="return Custom_login_text('textandcolorSave', '');"
                        class="btn btn-info btn-lg"><?php _e( 'Save Changes', WEBLIZAR_ACL_PRO ) ?></button>
            </div>
            <div class="pull-right">
                <button type="button" onclick="return Custom_login_text('textandcolorReset', '');"
    ...
    function Custom_login_text(Action, id) {
        if (Action == "textandcolorSave") {
            ...
            var button_color = jQuery("#button-color").val();
             var button_text_color = jQuery("#button-text-color").val();
            ...
            var google_font_token = jQuery("#google_font_token").val();
        ...
        if (Action == "textandcolorReset") {
            ...
            jQuery.ajax({
                ...
                success: function (data) {
                    ...
                    document.getElementById("google_font_token").value = 'Enter Google Token';
...
if ( isset( $_POST['Action'] ) ) {
	...
	if ( $Action == "textandcolorSave" ) {
		...
		$button_text_color    = sanitize_option( 'button_text_color', $_POST['button_text_color'] );
		...
		$google_font_token    = sanitize_option( 'google_font_token', $_POST['google_font_token'] );
		...
		$text_and_color_page = serialize( array(
			...
			'google_font_token'    => $google_font_token
		) );
