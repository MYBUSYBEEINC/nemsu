...
<script>
    ...
    jQuery(document).ready(function () {
        ...
        jQuery("#select-background").val('<?php if ( $top_bg_type != "" ) {
			echo $top_bg_type;
		} else {
			echo "";
		}?>');
        ...
        jQuery("#top_bg_repeat").val('<?php if ( $top_repeat != "" ) {
			echo $top_repeat;
		} else {
			echo "";
		}?>');
        ...
        jQuery("#top_bg_position").val('<?php if ( $top_position != "" ) {
			echo $top_position;
		} else {
			echo "";
		}?>');
        ...
        jQuery("#top_bg_attachment").val('<?php if ( $top_attachment != "" ) {
			echo $top_attachment;
		} else {
			echo "";
		}?>');
        ...
        //Top SlideShow No
        jQuery("#top_slideshow_no").val('<?php if ( $top_slideshow_no != "" ) {
			echo $top_slideshow_no;
		} else {
			echo "";
		}?>');

        //Top Slide Animation
        jQuery("#top_bg_slider_animation").val('<?php if ( $top_bg_slider_animation != "" ) {
			echo $top_bg_slider_animation;
		} else {
			echo "";
		}?>');
    });
...
<div class="row">
                    ...
                    <div class="post-social post-social-xs" id="post-social-5">
                        <div class="text-center padding-all text-center">
                            <div class="textbox text-white   margin-bottom settings-title">
								<?php _e( 'Background Settings', WEBLIZAR_ACL_PRO ) ?>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="panel-body">
            <table class="form-table">
                ...
                <tr class="radio-span" style="border-bottom:none;">
                    <td>
                        <select id="select-background" class="standard-dropdown" name="select-background"
                                onchange='getComboid()'>
                            <option value="no-background"><?php _e( 'No Background Selected', WEBLIZAR_ACL_PRO ) ?></option>
                            <optgroup label="<?php _e( 'Select Background', WEBLIZAR_ACL_PRO ) ?>">
                                ...
                                <option value="slider-background"><?php _e( 'Background SlideShow', WEBLIZAR_ACL_PRO ) ?></option>
                            </optgroup>
                        </select>
                    </td>
                </tr>
                ...
                <table class="form-table">
                    ...
                    <tr style="border-bottom:none;">
                        <td id="td-top-background-color">
                            <input id="top-background-color" name="top-background-color" type="text"
                                   value="<?php echo $top_color; ?>" class="my-color-field"
    ...
    <div id="div-bakground-image" class="no-background">
        ...
        <div class="panel panel-primary panel-default content-panel">
            <div class="panel-body">
                <table class="form-table">
                    ...
                    <tr style="border-bottom:none;">
                        <td>
                            <input type="text" class="pro_text" id="top_image"
                                   placeholder="<?php _e( 'No media selected!', WEBLIZAR_ACL_PRO ) ?>"
                                   name="upload_image" value="<?php echo $top_image; ?>"/>
                            ...
                            <input type="button" value="<?php _e( 'Preview', WEBLIZAR_ACL_PRO ) ?>" data-toggle="modal"
                                   data-target="#top_about_us_image_builder" id="top-image-previewer"
                                   title="Font Awesome Icons" class="button  " onclick="Acl_show_Image()"/>

                            <input type="button" id="display-logo" value="<?php _e( 'Remove', WEBLIZAR_ACL_PRO ) ?>"
                                   class="button" onclick="Acl_top_img_clear();"/>

                            <!-- Modal -->
                            <div class="modal " id="top_about_us_image_builder" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title"
                                                id="myModalLabel"><?php _e( 'Background Image', WEBLIZAR_ACL_PRO ) ?></h4>
                                        </div>

                                        <div class="modal-body">
                                            <img class="show_prev_img" src="" style="width:100%; height:50%"
                                                 id="top_img_prev"/>
                                        </div>
        ...
        <div class="panel panel-primary panel-default content-panel">
            <div class="panel-body">
                <table class="form-table">
                    <tr>
                        <th scope="row"><?php _e( 'Cover or Strech', WEBLIZAR_ACL_PRO ) ?></th>
                        <td></td>
                    </tr>
                    <tr style="border-bottom:none;">
                        <td>
                            <input type="checkbox" value="yes" id="bg-strech" name="strech-bg"
                                   onclick="OnChangeCheckbox(this)"
                                   style="visibility: visible;" <?php if ( $top_cover == "yes" ) {
								echo "checked";
							} ?>/>&nbsp;<?php _e( 'Yes', WEBLIZAR_ACL_PRO ) ?>
                        </td>
                    </tr>
                </table>
            </div>
        ...
        <div id="div-on-strech">
            ...
            <div class="panel panel-primary panel-default content-panel">
                <div class="panel-body">
                    <table class="form-table">
                        <tr>
                            <th scope="row"><?php _e( 'Background Attachment', WEBLIZAR_ACL_PRO ) ?></th>
                            <td></td>
                        </tr>
                        <tr class="radio-span" style="border-bottom:none;">
                            <td>
                                <select id="top_bg_attachment" class="standard-dropdown" name="top_bg_attachment">
                                    <option value="fixed"><?php _e( 'Fixed', WEBLIZAR_ACL_PRO ) ?> </option>
                                    <option value="scroll"><?php _e( 'Scroll', WEBLIZAR_ACL_PRO ) ?> </option>
                                    <option value="inherit"><?php _e( 'Inherit', WEBLIZAR_ACL_PRO ) ?> </option>
                                </select>
                            </td>
                        </tr>
                    </table>
    ...
    <div id="div-bakground-Slideshow" class="no-background">
        <div style="margin-bottom: 10px;">
            <img src="<?php echo WEBLIZAR_ACL_PLUGIN_URL_PRO . '/images/background-slideshow.png'; ?>"
                 class="img-responsive" style="margin-right: auto;">
        </div>
        ...
        <div class="panel panel-primary panel-default content-panel">
            <div class="panel-body">
                <table class="form-table">
                    <tr>
                        <th scope="row"><?php _e( 'No. Of Background Slideshow', WEBLIZAR_ACL_PRO ) ?></th>
                        <td></td>
                    </tr>
                    <tr style="border-bottom:none;">
                        <td>
                            <select id="top_slideshow_no" class="standard-dropdown" name="top_slideshow_no"
                                    onchange="set_slideshow()">
                                <option value="0"><?php _e( 'Select Number of Slide Show', WEBLIZAR_ACL_PRO ) ?> </option>
                                <option value="2"><?php _e( '2', WEBLIZAR_ACL_PRO ) ?> </option>
                                <option value="3"><?php _e( '3', WEBLIZAR_ACL_PRO ) ?> </option>
                                <option value="4"><?php _e( '4', WEBLIZAR_ACL_PRO ) ?> </option>
                                <option value="5"><?php _e( '5', WEBLIZAR_ACL_PRO ) ?> </option>
                                <option value="6"><?php _e( '6', WEBLIZAR_ACL_PRO ) ?> </option>
                            </select>
                        </td>
                    </tr>
                </table>
                ...
                <table class="form-table">
                    ...
                    <tr style="border-bottom:none;">
                        <td style="width:100% !important" id="tdslider">
							...
							for ( $i = 1; $i <= 6; $i ++ ) {
								?>
                                <div class="col-md-4 slideshow_settings" id="slideshow_settings_<?php echo $i; ?>"
                                     style="<?php if ( $i <= $top_slideshow_no ) {
									     echo " ";
								     } else { ?> display:none <?php } ?>">
                                    <div class="rpg-image-entry" id="rpg_img">
                                        <img src="<?php if ( $Slidshow_image[ 'Slidshow_image_' . $i ] != "" ) {
											echo $Slidshow_image[ 'Slidshow_image_' . $i ];
										} else {
											echo WEBLIZAR_ACL_PLUGIN_URL_PRO . 'images/rpg-default.jpg';
										} ?>" class="rpg-meta-image" alt="" style="" id="simages-<?php echo $i; ?>">
                                        <input type="button" id="upload-background-<?php echo $i; ?>"
                                               name="upload-background" value="Upload Image" class="button-primary"
                                               onClick="weblizar_image('<?php echo $i; ?>')"/>
                                        <input type="text" id="rpg_img_url-<?php echo $i; ?>"
                                               name="rpg_img_url-<?php echo $i; ?>"
                                               class="rpg_label_text-<?php echo $i; ?>" value="" readonly="readonly"
                                               style="display:none;"/>
                                    </div>
                                </div>
								<?php
        ...
        <div class="panel panel-primary panel-default content-panel">
            <div class="panel-body">
                <table class="form-table">
                    <tr>
                        <th scope="row"><?php _e( 'Slider Animation', WEBLIZAR_ACL_PRO ) ?></th>
                        <td></td>
                    </tr>
                    <tr class="radio-span" style="border-bottom:none;">
                        <td>
                            <select id="top_bg_slider_animation" class="standard-dropdown"
                                    name="top_bg_slider_animation">

                                <option value="slider-style1"><?php _e( 'Slider Animation 1', WEBLIZAR_ACL_PRO ) ?> </option>
                                <option value="slider-style2"><?php _e( 'Slider Animation 2', WEBLIZAR_ACL_PRO ) ?> </option>
                                <option value="slider-style3"><?php _e( 'Slider Animation 3', WEBLIZAR_ACL_PRO ) ?> </option>
                                <option value="slider-style4"><?php _e( 'Slider Animation 4', WEBLIZAR_ACL_PRO ) ?> </option>
                            </select>
                        </td>
                    </tr>
                </table>
    ...
    <div id="somedialog1" class="dialog" style="position: fixed; z-index: 9999;">
        ...
        <div class="dialog__content">
            <div class="morph-shape" id="morph-shape1"
                 data-morph-open1="M33,0h41c0,0,0,9.871,0,29.871C74,49.871,74,60,74,60H32.666h-0.125H6c0,0,0-10,0-30S6,0,6,0H33"
                 data-morph-close1="M33,0h41c0,0-5,9.871-5,29.871C69,49.871,74,60,74,60H32.666h-0.125H6c0,0-5-10-5-30S6,0,6,0H33">
            ...
            <div class="dialog-inner">
                <h2>
                    <strong><?php _e( 'Top Background', WEBLIZAR_ACL_PRO ) ?></strong> <?php _e( 'Setting Save Successfully', WEBLIZAR_ACL_PRO ) ?>
                </h2>
                <div>
                    <button class="action dialog-button-close" id="dialog-close-button1"
                            data-dialog-close><?php _e( 'Close', WEBLIZAR_ACL_PRO ) ?></button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="somedialog11" class="dialog" style="position: fixed; z-index: 9999;">
        ...
        <div class="dialog__content">
            ...
            <div class="dialog-inner">
                <h2>
                    <strong><?php _e( 'Top Background', WEBLIZAR_ACL_PRO ) ?></strong> <?php _e( 'Setting Reset Successfully', WEBLIZAR_ACL_PRO ) ?>
                </h2>
                <div>
                    <button class="action dialog-button-close" data-dialog-close
                            id="dialog-close-button11"><?php _e( 'Close', WEBLIZAR_ACL_PRO ) ?></button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="panel panel-primary save-button-block">
        <div class="panel-body">
            <div class="pull-left">
                <button type="button" onclick="return Custom_login_top('topbgSave', '');"
                        class="btn btn-info btn-lg"><?php _e( 'Save Changes', WEBLIZAR_ACL_PRO ) ?></button>
            </div>
            <div class="pull-right">
                <button type="button" onclick="return Custom_login_top('topbgReset', '');"
        ...
        if (Action == "topbgReset") {
            ...
            jQuery.ajax({
                ...
                success: function (data) {
                    ...
                    document.getElementById("top_image").value = "<?php echo WEBLIZAR_ACL_PLUGIN_URL_PRO?>/images/3d-background.jpg";
                    ...
                    for (i = 1; i <= 6; i++) {
                        jQuery("#simages-" + i).attr('src', '<?php echo WEBLIZAR_ACL_PLUGIN_URL_PRO?>/images/rpg-default.jpg');
                    }
