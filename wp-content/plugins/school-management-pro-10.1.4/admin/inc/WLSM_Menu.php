				...
				if ( in_array( $role, array_keys( WLSM_M_Role::get_roles() ) ) ) {
					...
					if ( WLSM_M_Role::check_permission( array( 'manage_classes', 'manage_subjects', 'manage_timetable', 'view_timetable',  'manage_attendance', 'manage_study_materials', 'manage_homework', 'manage_notices', 'manage_student_leaves', 'manage_events', 'manage_live_classes' ), $permissions ) ) {
						...
						if ( WLSM_M_Role::check_permission( array( 'manage_classes' ), $permissions ) ) {
							...
							$school_staff_classes_submenu = add_submenu_page( WLSM_MENU_STAFF_ACADEMIC, esc_html__( 'Sections', 'school-management' ), esc_html__( 'Class Sections', 'school-management' ), 'read', WLSM_MENU_STAFF_CLASSES, array( 'WLSM_Menu', 'school_staff_classes' ) );
						...
						if ( WLSM_M_Role::check_permission( array( 'manage_timetable','view_timetable'), $permissions ) ) {
							// Class - Timetable.
							$school_staff_timetable_submenu = add_submenu_page( WLSM_MENU_STAFF_ACADEMIC, esc_html__( 'Timetable', 'school-management' ), esc_html__( 'Timetable', 'school-management' ), 'read', WLSM_MENU_STAFF_TIMETABLE, array( 'WLSM_Menu', 'school_staff_timetable' ) );
					...
					if ( WLSM_M_Role::check_permission( array( 'manage_exams' ), $permissions ) ) {
						...
						if ( WLSM_M_Role::check_permission( array( 'manage_exams' ), $permissions ) ) {
							...
							// Examination - Admin Cards Print.
							$school_staff_exam_admit_cards_submenu = add_submenu_page( WLSM_MENU_STAFF_EXAMINATION, esc_html__( 'Admin Cards Print', 'school-management' ), esc_html__( 'Admit Cards Bulk Print', 'school-management' ), 'read', WLSM_MENU_STAFF_EXAM_ADMIT_CARDS_BULK_PRINT, array( 'WLSM_Menu', 'school_staff_exam_admit_cards_bulk_print' ) );
							add_action( 'admin_print_styles-' . $school_staff_exam_admit_cards_submenu, array( 'WLSM_Menu', 'menu_page_assets' ) );
