			...
			<div class="wlsm-form-section">
				...
				<div class="form-row">
					...
					<div class="form-group col-md-4">
						...
						<textarea name="note" class="form-control" id="wlsm_note" cols="30" rows="2" placeholder="<?php esc_attr_e( 'Enter extra detail.', 'school-management' ); ?>"><?php echo esc_html( stripcslashes( $note ) ); ?></textarea>
					</div>
				</div>
			</div>
			...
			<div class="wlsm-form-section">
				...
				<div class="form-row">
					...
					<div class="form-group col-md-4">
						...
						<br>
						<?php
						foreach ( $student_type_list as $key => $value ) {
							reset( $student_type_list );
							?>
							<div class="form-check form-check-inline">
								<input class="form-check-input" type="radio" name="student_type" id="wlsm_student_type_<?php echo esc_attr( $value ); ?>" value="<?php echo esc_attr( $key ); ?>" <?php checked( $key, $student_type, true ); ?>>
								<label class="ml-1 form-check-label wlsm-font-bold" for="wlsm_student_type_<?php echo esc_attr( $value ); ?>">
									<?php echo esc_html( $value ); ?>
								</label>
							</div>
							<?php
