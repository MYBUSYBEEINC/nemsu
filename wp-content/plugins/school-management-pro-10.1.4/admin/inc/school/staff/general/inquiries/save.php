			...
			<div class="wlsm-form-section">
				...
				<div class="form-row">
					...
					<div class="form-group col-md-6">
						...
						<textarea name="note" class="form-control" id="wlsm_note" cols="30" rows="4" placeholder="<?php esc_attr_e( 'Enter note', 'school-management' ); ?>"><?php echo esc_html( stripslashes( $note ) ); ?></textarea>
					</div>
				</div>
			</div>
