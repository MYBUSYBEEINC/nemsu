                        ...
                        <tbody>
                            ...
                            ?>
                             <tr>
                                ...
                                <td> <strong> <?php 
                                echo esc_html( WLSM_Config::get_money_text( $session_monthly_total + $session_onetime_total+ $session_quarterly_total + $session_half_yearly_total, $school_id ) ); ?> </strong></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
