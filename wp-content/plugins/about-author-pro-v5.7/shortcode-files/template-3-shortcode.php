<style>
    ...
    #A_b_t_main_<?php echo esc_attr( esc_attr($p_o_s_t)); ?>.web_lizar_main_div {
        width: auto;
        height: auto;
...
<div class="web_lizar_main_div" id="A_b_t_main_<?php echo esc_attr( $p_o_s_t ); ?>">
    ...
    <div align="center" class="web_lizar_user_name_div" id="A_b_t_name_div_<?php echo esc_attr( $p_o_s_t ); ?>">
        <h3 class="name_user"><?php echo $About_author_user_name; ?></h3>
    </div>
	...
	if ( $followbitbucket !== "" || $followdropbox !== "" || $followfb !== "" || $followflicker !== "" || $followgithub !== "" || $followgoogle !== "" || $followinsta !== "" || $followlinkdln !== "" || $followpinterest !== "" || $followtumbler !== "" || $followtwit !== "" || $followtVk !== "" ) {
		?>
        <div class="web_lizar_social_icon_div_use icon" id="A_b_t_social_icon_div_<?php echo esc_attr( $p_o_s_t ); ?>"
             align="center">
			...
			<?php if ( $followtwit !== "" ) {
                ...
                <a class="icon" class="icon" href="<?php echo esc_url( $followtwit ); ?>" target="_blank"
                   style="text-decoration: none;">
