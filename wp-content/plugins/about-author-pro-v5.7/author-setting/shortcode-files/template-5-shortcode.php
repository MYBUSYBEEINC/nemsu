...
<style>
    ...
    #A_b_t_discription_div_<?php echo  esc_attr($p_o_s_t); ?>.web_lizar_discription_div_author {
    ...
    #A_b_t_social_icon_div_<?php echo  esc_attr($p_o_s_t); ?> a > span:hover {
        ...
        border-radius: 0;
        background-color: <?php echo esc_attr($About_author_social_color);?>;
        color: <?php echo esc_attr($About_author_bg_color);?>;
        transform: scale(1.2);
    }
...
<div class="web_lizar_main_div" id="A_b_t_main_<?php echo esc_attr( $p_o_s_t ); ?>">
    ...
    <div align="left" class="web_lizar_image_div" id="A_b_t_img_<?php echo esc_attr( $p_o_s_t ); ?>">

		<?php if ( $switch_off_name == 'yes' ) { ?>
            <div align="center" class="web_lizar_user_name_div" id="A_b_t_name_div_<?php echo esc_attr( $p_o_s_t ); ?>">
                <h3 class="name_user" align="center"><?php echo esc_attr( $About_author_user_name ); ?></h3></div> <?php
		} ?>
    ...
    <div id="A_b_t_info_container_<?php echo esc_attr( $p_o_s_t ); ?>" class="web_lizar_info_cotainer">
		<?php if ( $switch_off_bio_info == 'yes' ) { ?>
            <div align="center" class="web_lizar_discription_div_author"
