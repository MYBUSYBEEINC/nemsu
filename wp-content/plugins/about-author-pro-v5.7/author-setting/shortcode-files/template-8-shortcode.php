...
<style>
    ...
    #A_b_t_design_div_author<?php echo  esc_attr($p_o_s_t); ?>.design_div_weblizar {
    ...
    #A_b_t_info_container_author_<?php echo  esc_attr($p_o_s_t); ?>.web_lizar_info_cotainer {
        margin-top: 80px;
    }
...
<div class="web_lizar_main_div" id="A_b_t_main_<?php echo esc_attr( $p_o_s_t ); ?>">
    <div align="center" id="A_b_t_img_<?php echo esc_attr( $p_o_s_t ); ?>">
		<?php if ( $switch_off_name == 'yes' ) { ?>
            <h3 class="name_user" align="center">   <?php echo esc_attr( $About_author_user_name ); ?>
            </h3>
		<?php } ?>
    ...
    <div align="center" class="design_div_weblizar" id="A_b_t_design_div_author<?php echo esc_attr( $p_o_s_t ); ?>">
        <div id="A_b_t_info_container_author_<?php echo esc_attr( $p_o_s_t ); ?>" class="web_lizar_info_cotainer">
			<?php if ( $switch_off_bio_info == 'yes' ) { ?>
                ...
                <p><?php echo esc_attr( $About_author_dis_cription ); ?></p> </div>  <?php } ?>
