...
<style>
    ...
    #A_b_t_main_<?php echo  esc_attr($p_o_s_t); ?>:hover a > span.web_lizar_Social_icon {
...
<div class="web_lizar_main_div" id="A_b_t_main_<?php echo esc_attr( $p_o_s_t ); ?>">
    <div align="left" class="web_lizar_image_div" id="A_b_t_img_<?php echo esc_attr( $p_o_s_t ); ?>">
        <h3 class="name_user" align="center"><?php if ( $switch_off_name == 'yes' ) {
    ...
    <div id="A_b_t_info_container_<?php echo esc_attr( $p_o_s_t ); ?>" class="web_lizar_info_cotainer">
        <div class="web_lizar_social_icon_div_use" id="A_b_t_social_icon_div_<?php echo esc_attr( $p_o_s_t ); ?>"
			...
			<?php if ( $followbitbucket !== "" ) {
				?>
                <a class="icon" href="<?php echo $followbitbucket; ?>" target="_blank" style="text-decoration: none;">
