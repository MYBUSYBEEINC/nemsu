...
<style>
    ...
    #A_b_t_main_<?php echo esc_attr($p_o_s_t); ?>:hover img {
        border-radius: 50%;
    ...
    #A_b_t_web_link_div_author<?php echo esc_attr($p_o_s_t); ?>.web_link_di_v {
        margin-top: 40px;
    }
...
<div class="web_lizar_main_div" id="A_b_t_main_<?php echo esc_attr( $p_o_s_t ); ?>">
    <div class="web_lizar_social_icon_div_use" id="A_b_t_social_icon_div_<?php echo esc_attr( $p_o_s_t ); ?>"
		...
		<?php if ( $followDigg !== "" ) {
			?>
            <a class="icon" href="<?php echo esc_url( $followDigg ); ?>" target="_blank" style="text-decoration: none;">
    ...
    <div align="center" id="A_b_t_img_<?php echo esc_attr( $p_o_s_t ); ?>">
		<?php if ( $switch_off_name == 'yes' ) { ?>
            <h3 class="name_user" align="center"><?php echo esc_attr( $About_author_user_name ); ?></h3>
		<?php } ?>
    ...
    <div id="A_b_t_info_container_<?php echo esc_attr( $p_o_s_t ); ?>" class="web_lizar_info_cotainer">
		...
		<?php if ( $switch_off_web == 'yes' ) { ?>
            <div align="center" id="A_b_t_web_link_div_author<?php echo esc_attr( $p_o_s_t ); ?>" class="web_link_di_v">
                <a target="_blank" class="web_lizar_web_link icon" style="text-decoration: none;"
